                        ...
                        <div class="hpanel email-compose mailbox-view">
                            ...
                            <div class="border-top border-left border-right bg-light">
                                <div class="p-m custom-address-mailbox">
                                    ...
                                    <div>
                                       <strong><span class="font-extra-bold">Código da Prova: </span> 18433799073</strong>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                     ...
                                     <div>
                                        <strong><span class="font-extra-bold">I -Questões objetivas –valendo  10,00 pontos Gerada em: 21/05/2018 19:10:57</span></strong>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body panel-csm">
                                <div>
                                    ...
                                    <p><strong>Questão 1:</strong> Os estudos recentes sobre o poder e a liderança têm demonstrado que ambos estão intimamente ligados. No que tange a estes temas de estudo, identifique a alternativa correta.</br>
                                    </br>

                                    A) O poder é definido como a habilidade para conseguir que outra pessoa faça o que se quer, e estárelacionado à posição hierárquica do indivíduo.</br>
                                    ...
                                    <p><strong>Questão 2:</strong> Em relação aos estudos da motivação desenvolvidos por McGregor, sobre a forma como os empregados eram tratados pelos administradores, podemos afirmar que NÂOé um pressuposto da teoria Y.</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 3:</strong> Análise transacional se constitui de um conjunto de técnicas que visam à mudança. Chama-se transacional por estudar, analisar as trocas de estímulos e respostas entre os indivíduos, ou transações, entre indivíduos. Na análise transacional comportamento é definido como:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 4:</strong> Você estudou sobre motivação e suas teorias. Leia as afirmativas a seguir e assinale a alternativa correta.</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 5:</strong> Embora muitas vezes o trabalho seja visto como algo penoso e desagradável, ninguém vivesem o trabalho. A nossa realização pessoal passa necessariamente pela nossa realização profissional.Abaixo são feitas algumas afirmações sobre o ser humano e sua relação com o trabalho.</br>
                                    </br>

                                    I -O trabalho é uma atividade tipicamente humana. Nós criamos o trabalho e, trabalhamos porque somos humanos.</br>
                                    ...
                                    <p><strong>Questão 6:</strong> O gerente Jaime está fazendo um curso de comportamento organizacional. Ele provavelmente aprenderá todos os tópicos a seguir exceto:</br>
                                    </br>

                                    A) Ações e atitudes em ambientes organizacionais.</br>
                                    ...
                                    <p><strong>Questão 7:</strong> Segundo a teoria dos 2 fatores de Herzberg  identifique o que vem a ser motivação: </br>
                                    </br>
                                    ...
                                    <p><strong>Questão 8:</strong> Segundo Hersey e Blanchard uma liderança pode ser bem sucedida ou mal sucedida, e aindavariar seu grau de eficácia, de ineficaz até eficaz. Então, de acordo com os autores podemos dizer que uma liderança foi bem sucedida, mas ineficaz. Assinale a alternativa que traduza o significado de uma liderança bem sucedida mas ineficaz.</br>
                                    </br>

                                    A) A despeito dos esforços do líder, sua equipe nunca atinge os objetivos.</br>

                                    B) A equipe sempre compreende os objetivos a serem atingidos.</br>

                                    C) O líder se utiliza de coerção para fazer com que a equipe atinja as metas.</br>

                                    D) Os liderados agem como líderes, não necessitando de direcionamento.</br>

                                    E) A equipe apesar de entender a necessidade de atingir o objetivo, não os atinge.</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 9:</strong> Trabalhar em equipe é muito mais do que realizar tarefas em conjunto ou compartilhá-las, esse trabalho consiste em comprometimento e participação da equipe para atingir um determinado objetivo. E para isso é necessário desenvolver as seguintes competências:</br>
                                    </br>

                                    A) Relacionamento interpessoal, efetuando uma boa relação com a equipe, estar atento nas atitudes,para melhor direcionar na atuação frente somente aos acontecimentos previstos.</br>
                                    ...
                                    Assinale a alternativa correta em relação a liderança situacional.</br>
                                    </br>
