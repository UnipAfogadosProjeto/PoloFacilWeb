                        ...
                        <div class="hpanel email-compose mailbox-view">
                            ...
                            <div class="border-top border-left border-right bg-light">
                                <div class="p-m custom-address-mailbox">
                                    ...
                                    <div>
                                       <strong><span class="font-extra-bold">Código da Prova: </span> 18202737853</strong>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                     ...
                                     <div>
                                        <strong><span class="font-extra-bold">I -Questões objetivas –valendo  10,00 pontos Gerada em: 10/12/2018 18:49:55</span></strong>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body panel-csm">
                                <div>
                                    ...
                                    <p><strong>Questão 1:</strong> Quinn et al. (2003) sugere algumas regras para a comunicação eficaz e também aponta alguns empecilhos à comunicação interpessoal efetiva, referentes à capacidade dos envolvidos de enviar e receber mensagens. Os entraves são: falta de articulação; segundas intenções; status; hostilidade e os diferentes estilos de comunicação. Hostilidade, nesse contexto, significa:</br>
                                    </br>

                                    I -Dificuldade do emissor para expressar o conceito e desconhecimento sobre o assunto por parte do receptor.</br>

                                    II -De forma errônea, às vezes, podemos não ser receptivos às ideias e opiniões daqueles que estão em posição inferior.</br>

                                    III -Quando o receptor já está prevenido contra o emissor, a comunicação tende a ser percebida demaneira negativa, independente se a intenção é essa ou não.</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 2:</strong> Segundo Covey (2005), para ter liderança baseada em princípios é necessário comportar-se segundo uma decisão consciente, baseado nos seus valores, e não nas condições nas quais se encontra,nem na forma como foi criado, nem na sua carga genética. É saber escolher com base na autoconsciência, imaginação, consciência e independência.</br>
                                    </br>

                                    A essa liberdade de escolha Covey dá o nome de:</br>
                                    </br>

                                    A) Reatividade.</br>

                                    B) Gerência centrada.</br>
                                    ...
                                    <p><strong>Questão 3:</strong> Daniel Goleman (1995) discute a importância da inteligência emocional na liderança e amapeia em cinco áreas de habilidades. Goleman, nos estudos sobre inteligência intrapessoal, diz o seguinte sobre o controle emocional:</br>
                                    </br>

                                    I -Habilidade de reconhecer um sentimento enquanto ele ocorre. </br>

                                    II -Habilidade de lidar com seus próprios sentimentos, adequando-os para a situação. </br>

                                    III -Dirigir emoções a serviço de um objetivo é essencial para manter-se caminhando sempre em busca.</br>

                                    IV -Habilidade de lidar com as dificuldades gerenciais da liderança.</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 5:</strong> Na discussão sobre o papel do negociador, relata-se que o poder pode ser definido como a habilidade de influenciar pessoas por meio do controle dos recursos organizacionais, ou seja, a competência para conseguir que o indivíduo faça aquilo que se quer. É preciso ter cuidado com as diversidades de situações que os líderes encontram ao exercer o poder dentro da instituição. O líderprecisa saber para qual finalidade usará o poder e, quando este for executado, definir o que se deve esperardo funcionário em contrapartida. Conforme Kelman apud Hollenbeck (1999), é provável que existamtrês tipos distintos de “respostas” ao tipo de poder: obediência, identificação e internalização. Assim, se a proposta do líder é garantir a _______________, poderá usar o poder de recompensa e o poder coercitivo. Se a intenção é assegurar a _____________, então deverá se utilizar do poder de referência. E se objetivo é afiançar a ___________, então deverá empregar os poderes legítimos e sua especialização.</br>
                                    </br>

                                    Assinale a alternativa que completa adequadamente as lacunas do texto.</br>
                                    </br>

                                    A) Obediência, identificação, internalização.</br>

                                    B) Legitimização, identificação, internalização.</br>

                                    C) Internalização, obediência, identificação.</br>

                                    D) Identificação, legitimização, internalização.</br>

                                    E) Identificação, internalização, obediência.</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 6:</strong> Leia com atenção as afirmativas a seguir: </br>
                                    </br>
                                    ...
                                    A) Recepciona/interpretações.</br>
                                    ...
                                    E) Recepciona/respostas.</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 7:</strong> Daniel Goleman (1995) mapeia a inteligência emocional em cinco áreas de habilidades, divididas entre inteligência intrapessoal e inteligência interpessoal. A inteligência intrapessoal consiste em:</br>
                                    </br>

                                    I -Habilidade de formar modelos e usá-los de forma efetiva e construtiva para entender os outros.</br>
                                    ...
                                    I -Uma conduta psicológica dos órgãos sensoriais.</br>
                                    ...
                                    <p><strong>Questão 9:</strong> Nos estudos de Collins e Porras (1998) sobre ideologia central, a segunda parte discute a “finalidade básica” como um argumento motivador das pessoas para executar seu trabalho na empresa. Essa finalidade se diferencia das metas específicas ou estratégias comerciais na medida em que podemos atingir metas ou concluir estratégias, mas não podemos concretizar uma finalidade.</br>
                                    </br>

                                    Nesse sentido, podemos entender a finalidade básica como:</br>
                                    </br>

                                    A) Uma linha de chegada bem definida para que a organização saiba que a atingiu.</br>

                                    B) Uma visão aplicada à empresa inteira, exigindo de dez a trinta anos de esforços para ser alcançada.</br>

                                    C) A descrição envolvente e detalhada do que deve ser atingido com as metas.</br>

                                    D) A razão de ser da instituição.</br>

                                    E) A constituição de uma visão em vez de formular apenas estratégias ou táticas.</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 10:</strong> A principal função administrativa dentro da estrutura organizacional é:</br>
                                    </br>

                                    A) Atrair, congregar, gerir e retribuir o capital aplicado.</br>

                                    B) Preservar os bens e as pessoas contra roubo, incêndio, inundações, bem como todos os fatores deordem social e ambiental que possam comprometer a vida da empresa. </br>

                                    C) Fornecer, de forma sintética e sistematizada, as informações e os dados capazes de retratar a mensuração das atividades da organização, oferecendo bases para o controle. </br>
