                        ...
                        <div class="hpanel email-compose mailbox-view">
                            ...
                            <div class="border-top border-left border-right bg-light">
                                <div class="p-m custom-address-mailbox">
                                    ...
                                    <div>
                                       <strong><span class="font-extra-bold">Código da Prova: </span> 18652298832</strong>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                     ...
                                     <div>
                                        <strong><span class="font-extra-bold">I -Questões objetivas –valendo  10,00 pontos Gerada em: 23/05/2018 12:03:32</span></strong>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body panel-csm">
                                <div>
                                    ...
                                    <p>Disciplina: 539780 - Gestão das Informações </p>

                                    <p><strong>Questão 1:</strong> O que é a Marca de uma empresa estampada em um produto? .</br>
                                    </br>

                                    A) Marca é um registro do produto.</br>

                                    B) É um contrato de permissão de uso de um produto e serviço.</br>

                                    C) É um símbolo de identidade.</br>

                                    D) É um ícone reconhecido exclusivamente pelo mercado concorrente. </br> 

                                    E) Marca é um signo, um desenho um ícone ou uma expressão que representa o detentor de uma propriedade intelectual de um produto, de uma empresa ou de um serviço, o bem mais valioso entre os imobilizados, o maior e invisível.  </br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 2:</strong> Planejamento estratégico da empresa; planejamento estratégico da informação; análise daárea de negócios; projeto de sistemas; construção do sistema; implantação do sistema; manutenção do sistema, são etapas de:</br>
                                    </br>

                                    A) Desenvolvimento de sistemas integrados.</br>

                                    B) Desenvolvimento e implantação de sistemas de informação.</br>

                                    C) Desenvolvimento e implantação de sistemas de informação gerencial.</br>

                                    D) Desenvolvimento e implantação de sistemas internos.</br>

                                    E) Desenvolvimento e implantação de sistemas de inteligência ao executivo.</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 3:</strong> São ferramentas de software para apoio e suporte as decisões essenciais ao processo decisório composto de pessoas, procedimentos, banco de dados e precisam apresentar certa flexibilidade para atender a dados internos e externos à organização. Estamos falando de sistemas:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 4:</strong> O sistema de informação competitiva concentra-se em três pontos. São eles:</br>
                                    </br>

                                    A) Pesquisa em tempo real do mercado, pesquisa de preço e concorrência e um bom planejamento logístico para escoamento da produção.</br>

                                    B) Criação de um bom conceito de programa, hardware potente para que sejam disponibilizadas de forma rápida as informações e clientes dispostos a comprar a ideia.</br>

                                    C) Vantagem competitiva, fatores-chave de sucesso e grupo de informação.</br>

                                    D) Plano diretor de informática, planejamento estratégico da informação e cultura da informação.</br>

                                    E) os níveis estratégico, tático e operacional.</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 5:</strong> São sistemas projetados para aperfeiçoar processos de planejamento e controle e fornecer ao executivo novas informações -ou as já existentes -mais rapidamente, revolucionando o fluxo das informações. Referem-se aos sistemas:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 6:</strong> Refere-se à síntese dos resultados relevantes para a organização como um todo, levando-se em consideração todas as partes interessadas. É o desempenho planejado pela estratégia da organização com uma abordagem preliminar dos conjuntos de indicadores, é a avaliação do progresso em relação as estratégias, planos e metas, apoiar as decisões e tomar rumos na identificação de oportunidades. Estamos nos referindo:</br>
                                    </br>

                                    A) Ao desempenho global.</br>

                                    B) À estratégia comparativa global.</br>

                                    C) À estratégia competitiva.</br>

                                    D) À monitoração global.</br>

                                    E) À integração global. </br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 7:</strong> Qual é o elemento importante em sistemas de computadores formador de agrupamento de elementos processáveis eletronicamente que tem como características ser: único, sem sentido, orientação ou unidade quantificável. Tipificamos aqui os:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 8:</strong> Qual é o sistema baseado em controle integrado da produção e da gestão do negócio?</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 9:</strong> Este item é o valor agregado aos produtos da organização por meio de informação e conhecimento. Ele é composto pelas habilidades e conhecimentos das pessoas, pela tecnologia e pelos processos ou pelas características específicas de uma organização. Os dados trabalhados se transformam em informação. A análise da informação produz o conhecimento. O conhecimento utilizado, de maneira organizada, como forma de incrementar o acervo de experiências e a cultura da organização, se constitui em capital intelectual. A gestão desse item ocupa-se da forma como a organização estimula, identifica, desenvolve e protege o conhecimento e o acervo tecnológico para desenvolver esse item. O texto está se referindo:</br>
                                    </br>

                                    A) Exclusivamente à Gestão de Marcas e Patentes.</br>

                                    B) Ao Capital Intelectual.</br>

                                    C) À Gestão das Informações Internas.</br>

                                    D) À Gestão das Informações Externas e comparativas.</br>

                                    E) À Análise Crítica do Desempenho Global</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 10:</strong> O nível mais apropriado ao operador geralmente requer informações detalhadas sobre operações do dia a dia, e não a informação ampla e estratégica. Estamos falando de:</br>
                                    </br>

                                    A) Informações gerenciais.</br>

                                    B) Informações operacionais.</br>

                                    C) Sistemas de informações.</br>

                                    D) Sistemas de informações gerenciais.</br>

                                    E) Sistemas de informações integrados.</br>
