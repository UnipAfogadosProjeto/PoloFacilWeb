<?php session_start(); 
    ...
    $bread = '/ Provas / Administração / VOLEIBOL: ASPECTOS PEDAGÓGICOS E APROFUNDAMENTOS';
    $active = ['', '', ''];
...
<head>
    ...
    <title>Provas - Educação Física - VOLEIBOL: ASPECTOS PEDAGÓGICOS E APROFUNDAMENTOS | Polo Fácil</title>
                        ...
                        <div class="hpanel email-compose mailbox-view">
                            ...
                            <div class="border-top border-left border-right bg-light">
                                <div class="p-m custom-address-mailbox">
                                    ...
                                    <div>
                                       <strong><span class="font-extra-bold">Código da Prova: </span> 19879452408</strong>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <strong><span class="font-extra-bold">II -Questões discursivas –valendo  5,00 pontos Gerada em: 02/04/2019 08:52:43</span></strong>
                                    </div>
                            ...
                            <div class="panel-body panel-csm">
                                <div>
                                    ...
                                    <p><strong>Questão 1:</strong> No ensino do voleibol qual deve ser a atitude do professor de Educação Física com relação ao ensinodas formações táticas?</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 2:</strong> Quais regras do jogo de voleibol poderiam ser adaptadas para campeonatos de categoriasmenores e escolares?</br>
                                    </br>

                                    A)  A obrigatoriedade de realizar 3 toques e utilização do saque por baixo.</br>

                                    B)  A utilização de 9 jogadores em cada quadra e suspensão do rodízio.</br>

                                    C)  O uso do saque por cima e do sistema 6x0.</br>

                                    D)  O uso do líbero e suspensão do rodízio.</br>

                                    E)  O uso do saque por baixo e utilização de todos os jogadores (reservas) durante o jogo.</br>
                                    
                                    </br>
                                    </p>

                                    <p><strong>Questão 3:</strong>  A prática do Voleibol é indicada: </br>
                                    </br>

                                    A)  Apenas para atletas de nível elevado.</br>

                                    B)  Para pessoas de qualquer idade.</br>

                                    C)  Para pessoas sem deficiência, pois não existe o voleibol adaptado.</br>

                                    D)  Apenas em ambientes fechados.</br>

                                    E)  Para qualquer pessoa, desde que seja aplicado de forma adaptada às necessidades dos alunos.</br>

                                    </p>

                                    <p><strong>Questão 4:</strong> Aponte a alternativa correta a respeito do saque por baixo:</br>
                                    </br>

                                    A)  É mais fácil para o aluno aprender se ele lançar a bola bem alta antes de sacar.</br>

                                    B)  A bola deve lançada a uma altura máxima de 30 cm.</br>

                                    C)  A perna que deve estar à frente é a do mesmo lado que bate na bola (ex.: perna direita com braço direito).</br>

                                    D)  A bola deve bater no braço.  </br>

                                    E)  A bola deve ser batida nas costas da mão.</br>

                                    </br>

                                    </p>

                                    <p><strong>Questão 5:</strong> Verifique qual das afirmações abaixo é correta sobre a técnica de execução do bloqueio.</br>
                                    </br>

                                    A)  O bloqueio deve ser realizado com uma ou duas mãos.</br>

                                    B)  No movimento de bloqueio o jogador deve golpear a bola com as duas mãos, como num ataque.</br>

                                    C)  No bloqueio ofensivo o jogador invade o espaço aéreo da quadra adversária.</br>

                                    D)  Na execução do bloqueio é permitido o toque na rede.</br>

                                    E)  Na execução do bloqueio os braços são elevados pelas laterais do corpo durante o salto.</br>

                                    </br>

                                    </p>

                                    <p><strong>Questão 6:</strong> No Voleibol há diversos sistemas de jogo como o 6x0, o 5x1, o 4x2 (6x2), e o 3x3, que determinam acomposição da equipe em termos de levantadores e atacantes. Para uma equipe de principiantes, qual o melhor sistema a ser aplicado?</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 7:</strong> Com relação à formação para recepção de saque em “W”, é correto afirmar que:</br>
                                    </br>

                                    A)  para receber o saque, 3 jogadores devem ficar na zona de ataque e três na zona de defesa.</br> 

                                    B)  os jogadores que vão receber o saque devem ficar distribuídos na zona de maior incidência de saques.</br>

                                    C)  é melhor que os jogadores não se comuniquem uns com os outros no momento da recepção.</br>

                                    D)  não existem setores definidos para a responsabilidade de cada jogador, quem chegar primeiro faz o passe.</br>

                                    E)  é uma ação tranquila do jogo, pois é muito fácil fazer a recepção do saque.</br>

                                    </br>

                                    <p>

                                    <p><strong>Questão 8:</strong> A característica metabólica predominante do jogo de Voleibol, na sua parte ativa é:</br>
                                    </br>

                                    A)  Aeróbia. </br> 

                                    B)  Anaeróbia lática.</br>

                                    C)  Anaeróbia. </br>

                                    D)  Anaeróbia alática.</br>
                                    ...
                                    <p><strong>Questão 2:</strong> Qual a idade ideal para o início da aprendizagem correta das técnicas do voleibol?Justifique.</br>
