...
<head>
    ...
    <title>Provas - Recursos Humanos | Polo Fácil</title>
                        ...
                        <div class="product-status-wrap">
                            ...
                            <div class="asset-inner">
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="18266328320_etica_e_legislacao_trabalhista_e_empresarial.php"class="pd-setting"><i class="fa fa-book" aria-hidden="true"></i> Ética e Legislação: Trabalhista e Empresarial</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <a href="18558014898_recursos_materiais_e_patrimoniais.php"class="pd-setting"><i class="fa fa-book" aria-hidden="true"></i> Recursos Materiais e Patrimoniais</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <a href="18949185453_plano_de_negocios.php"class="pd-setting"><i class="fa fa-book" aria-hidden="true"></i> Plano de Negócios</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <a href="18951275663_matematica_aplicada.php"class="pd-setting"><i class="fa fa-book" aria-hidden="true"></i> Matemática Aplicada</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <a href="8362818924_economia_e_mercado.php"class="pd-setting"><i class="fa fa-book" aria-hidden="true"></i> Economia e Mercado</a>
                                        </td>
                                    </tr>
                                </table>
