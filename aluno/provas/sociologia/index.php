                        ...
                        <div class="product-status-wrap">
                            ...
                            <div class="asset-inner">
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="18452759876_didatica_geral.php"class="pd-setting"><i class="fa fa-book" aria-hidden="true"></i> Didática Geral</a>
                                        </td>
                                    </tr> 
                                    <tr>
                                        <td>
                                            <a href="18526084144_metodologia_de_ensino_aplicada_as_ciencias_sociais.php"class="pd-setting"><i class="fa fa-book" aria-hidden="true"></i> Metodologia de Ensino aplicada às Ciências Sociais</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <a href="18632508025_teoria_antropologica.php"class="pd-setting"><i class="fa fa-book" aria-hidden="true"></i> Teoria Antropológica</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <a href="18829320872_pensamento_politico_brasileiro.php"class="pd-setting"><i class="fa fa-book" aria-hidden="true"></i> Pensamento Político Brasileiro</a>
                                        </td>
                                    </tr>
                                </table>
