<?php session_start(); 
    ...
    $bread = '/ Provas / Servico Social / PLANEJAMENTO E GESTÃO SOCIAL';
    $active = ['', '', ''];
...
<head>
    ...
    <title>Provas - Servico Social - PLANEJAMENTO E GESTÃO SOCIAL | Polo Fácil</title>
                        ...
                        <div class="hpanel email-compose mailbox-view">
                            ...
                            <div class="border-top border-left border-right bg-light">
                                <div class="p-m custom-address-mailbox">
                                    ...
                                    <div>
                                       <strong><span class="font-extra-bold">Código da Prova: </span> 19640376523</strong>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                     ...
                                     <div>
                                        <strong><span class="font-extra-bold">I -Questões objetivas –valendo  10,00 pontos Gerada em: 02/04/2019 10:27:17</span></strong>
                                    </div>
                            ...
                            <div class="panel-body panel-csm">
                                <div>
                                    ...
                                    <p>Disciplina: 703660 - PLANEJAMENTO E GESTÃO SOCIAL</p>

                                    <p><strong>Questão 1:</strong> Uma empresa que reduz o uso de materiais reutiliza-os e recicla-os mais amplamente, produz um impacto significativo no ecossistema, o que inclusive pode suscitar ambientes participativos e mais criativos na busca pelo uso de alternativas inteligentes de consumo. Nesse sentido, assinale a alternativa que corresponde a uma postura empresarial preventiva e que evita riscos futuros, como impactos ambientais ou processos judiciais:</br>
                                    </br>

                                    A) Ser distributiva</br>

                                    B) Ser transparente</br>

                                    C) Ser colaborativa</br>

                                    D) Ser sustentável</br>
                                    ...
                                    <p><strong>Questão 2:</strong> Assinale a alternativa que está relacionada ao crescimento quantitativo e qualitativo das tarefas administrativas do Estado moderno:</br>
                                    </br>

                                    A) Economia solidária</br>

                                    B) Responsabilidade social</br>

                                    C) Burocracia moderna</br>

                                    D) Legislação trabalhista</br>

                                    E) Direitos trabalhistas</br>
                                    
                                    </br>
                                    </p>

                                    <p><strong>Questão 3:</strong> Assinale a alternativa que corresponde a uma das orientações básicas da reforma gerencial promovida no Estado brasileiro:</br>
                                    </br>

                                    A) Orientação social</br>

                                    B) Orientação judicial</br>

                                    C) Orientação técnica</br>

                                    D) Orientação nacional</br>

                                    E) Orientação internacional</br>
                                    </p>

                                    <p><strong>Questão 4:</strong> Qual tipo de controle corresponde ao poder de fiscalização e correção que a administração pública exerce sobre seus próprios atos?</br>
                                    </br>

                                    A) Controle administrativo</br>

                                    B) Controle político</br>

                                    C) Controle financeiro</br>

                                    D) Controle judicial</br>

                                    E) Controle legislativo</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 5:</strong> Complete as lacunas com uma das alternativas abaixo:Caso a administração pública torne-se menos burocrática e mais flexível, suas ações serão mais _______________ e estarão voltadas ao bom uso dos recursos públicos.</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 6:</strong> Das alternativas abaixo, qual pode ser citada como característica do investimento em valores éticos, que agregam à marca e alcançam resultados satisfatórios para as organizações?</br>
                                    </br>

                                    A) Planejamento estratégico</br>

                                    B) Planejamento orçamentário</br>

                                    C) Orçamento participativo</br>

                                    D) Orçamento impositivo</br>

                                    E) Planejamento previdenciário</br>
                                    
                                    </br>

                                    </p>

                                    <p><strong>Questão 7:</strong> Quem foi o criador da Administração Científica?</br>
                                    </br>
                                    ...
                                    E) Frederick Winslow Taylor</br>
                                    
                                    </br>

                                    <p>

                                    <p><strong>Questão 8:</strong> Assinale a alternativa que corresponde às entidades que não fazem parte da administração direta ou indireta, já que não são empresas paraestatais, mas, sim, entidades privadas que prestam serviços privados de caráter ou de interesse público:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 9:</strong> Elaborar um sistema social que garanta emprego, segurança social e respeito a outras culturas e erradique a miséria, o preconceito e o massacre de populações oprimidas, possui relação com:</br>
                                    </br>

                                    A) Apelo humanitário</br>

                                    B) Preservação da identidade cultural</br>

                                    C) Desenvolvimento sustentável</br>

                                    D) Concretização da ação social</br>

                                    E) Crença na formação de empreendedores</br>
                                    
                                    </br>

                                    </p>

                                    <p><strong>Questão 10:</strong> Nos dias atuais, nota-se uma preocupação nas organizações com a promoção de açõesdentro do universo do desenvolvimento sustentável. A partir dessa preocupação, há investimentos nas pessoase, consequentemente, na sociedade. Nesse sentido, o que pode ser definido como realizações das empresas preocupadas com esse novo cenário?</br>
                                    </br>

                                    A) Papel social da organização</br>

                                    B) Responsabilidade societária</br>

                                    C) Política social</br>

                                    D) Organização social</br>

                                    E) Ética da convicção</br>
