<?php session_start(); 
    ...
    $bread = '/ Provas / Serviço Social / PLANEJAMENTO E GESTÃO SOCIAL';
    $active = ['', '', ''];
...
<head>
    ...
    <title>Provas - Serviço Social - PLANEJAMENTO E GESTÃO SOCIAL | Polo Fácil</title>
                        ...
                        <div class="hpanel email-compose mailbox-view">
                            ...
                            <div class="border-top border-left border-right bg-light">
                                <div class="p-m custom-address-mailbox">
                                    ...
                                    <div>
                                       <strong><span class="font-extra-bold">Código da Prova: </span> 19267418621</strong>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                     ...
                                     <div>
                                        <strong><span class="font-extra-bold">I -Questões objetivas –valendo  10,00 pontos Gerada em: 02/04/2019 10:36:14</span></strong>
                                    </div>
                            ...
                            <div class="panel-body panel-csm">
                                <div>
                                    ...
                                    <p><strong>Questão 1:</strong> Das alternativas abaixo, qual representa um dos 14 fatores básicos da Teoria Administrativa desenvolvida por Fayol? </br>
                                    </br>
                                    ...
                                    <p><strong>Questão 2:</strong> Relacionado com o conceito comportamentalista da organização, assinale a alternativa que corresponde ao sistema onde ocorre a solução de conflitos por meio de repressão, arbitragem e/ou hostilidade:</br>
                                    </br>

                                    A) Sistemas mecânicos</br>

                                    B) Sistemas orgânicos</br>

                                    C) Sistemas políticos</br>

                                    D) Sistemas participativos</br>

                                    E) Sistemas complexos</br>

                                    </br>
                                    </p>

                                    <p><strong>Questão 3:</strong> Complete a lacuna com uma das alternativas abaixo:A administração _________________ surge com olhos na satisfação do cidadão-cliente. Redireciona o foco dos processos para o real objetivo de existência da administração, ou seja, satisfazer a sociedade em suas vitais necessidades (MAJONE, 1999).</br>
                                    </br>

                                    A) Burocrática</br>

                                    B) Pública gerencial</br>

                                    C) Patrimonialista</br>
                                    ...
                                    <p><strong>Questão 4:</strong> Assinale a alternativa que está relacionada ao crescimento quantitativo e qualitativo das tarefas administrativas do Estado moderno:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 5:</strong> Complete a lacuna com uma das alternativas abaixo:</br>
                                    </br>

                                    A expressão _________________ apresenta diferentes conotações dependendo do contexto em que é utilizada, que pode ser tanto semântico quanto representativo de dispositivos jurídicos existentes.</br>
                                    </br>

                                    A) Planejamento político</br>

                                    B) Controle social</br>

                                    C) Planejamento estratégico</br>

                                    D) Planejamento social</br>

                                    E) Controle político</br>

                                    </br>

                                    </p>

                                    <p><strong>Questão 6:</strong> Assinale a alternativa que corresponde às entidades que não fazem parte da administração direta ou indireta, já que não são empresas paraestatais, mas, sim, entidades privadas que prestam serviços privados de caráter ou de interesse público:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 7:</strong>  Elaborar um sistema social que garanta emprego, segurança social e respeito a outras culturas e erradique a miséria, o preconceito e o massacre de populações oprimidas, possui relação com:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 8:</strong> Dos autores nomeados abaixo, qual desenvolveu uma teoria administrativa que se iniciou na França em 1916?</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 9:</strong> Complete as lacunas com uma das alternativas abaixo:Caso a administração pública torne-se menos burocrática e mais flexível, suas ações serão mais _______________ e estarão voltadas ao bom uso dos recursos públicos.</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 10:</strong> "As pessoas trabalham para ter seu dinheiro e ter reconhecimento profissional. Elas escolhem em qual das classes sociais desejam estar incluídas e lutam por essa posição. As que têm maior ambição trabalham mais para ganhar mais dinheiro ou abrem o seu próprio negócio, enquanto as demais trabalham para satisfazer suas necessidades particulares (SILVA, 2004)".</br>
                                    </br>

                                    Assinale a alternativa que está relacionada com a afirmação acima:</br>
                                    </br>

                                    A) Administração pública</br>

                                    B) Administração privada</br>

                                    C) Administração patrimonialista</br>
