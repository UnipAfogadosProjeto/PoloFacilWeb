<?php session_start(); 
    ...
    $bread = '/ Provas / Ciências Contábeis / TECNOLOGIAS DA INFORMAÇÃO';
    $active = ['', '', ''];
...
<head>
    ...
    <title>Provas - Ciências Contábeis - TECNOLOGIAS DA INFORMAÇÃO | Polo Fácil</title>
                        ...
                        <div class="hpanel email-compose mailbox-view">
                            ...
                            <div class="border-top border-left border-right bg-light">
                                <div class="p-m custom-address-mailbox">
                                    ...
                                    <div>
                                       <strong><span class="font-extra-bold">Código da Prova: </span> 19374365624</strong>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                     ...
                                     <div>
                                        <strong><span class="font-extra-bold">I -Questões objetivas –valendo  10,00 pontos Gerada em: 02/04/2019 10:18:22</span></strong>
                                    </div>
                            ...
                            <div class="panel-body panel-csm">
                                <div>
                                    ...
                                    <p>Disciplina: 537260 - TECNOLOGIAS DA INFORMAÇÃO</p>

                                    <p><strong>Questão 1:</strong> Em relação à procura de valores em colunas do Excel, qual o modelo correto de sintaxe?</br>
                                    </br>

                                    A)  =procv(condição; caso verdadeiro; caso real).</br>

                                    B)  =se(condição; caso real; caso falso).</br>

                                    C)  =procv(valor procurado; matriz tabela; num índice coluna; procurar intervalo).</br>

                                    D)  =se(condição; caso irreal; caso real).</br>

                                    E)  =se(condição; caso falso; caso verdadeiro).</br>

                                    </br>
                                    </p>

                                    <p><strong>Questão 2:</strong> O que podemos digitar em uma célula do Excel para a realização de cálculos?</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 3:</strong>  O tipo de memória com grande capacidade de armazenamento é denominado:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 4:</strong> Quanto às redes:</br>
                                    </br>

                                    A)  Servem para uso da Internet.</br>

                                    B)  Existem para compartilhamento de recursos.</br>

                                    C)  São usadas somente para cópia de segurança de arquivos.</br>

                                    D)  São usadas exclusivamente para EDI -Eletronic Data Interchange(Troca Eletrônica de Documento).</br>

                                    E)  São usadas exclusivamente para EIS -Eletronic Interchange System(Troca Eletrônica deSistema).</br>

                                    </br>

                                    </p>

                                    <p><strong>Questão 5:</strong> Quando falamos de periféricos, é certo afirmar:</br>
                                    </br>

                                    A)  A Internet aumentou o uso e a insegurança deles.</br>

                                    B)  Não existe diferença entre eles.</br>

                                    C)  São dispositivos de rede exclusivamente.</br>

                                    D)  Passaram a ser mais rápidos com o advento dos microcomputadores.</br>


                                    E)  Estão cada vez mais caros.</br>

                                    </br>

                                    </p>

                                    <p><strong>Questão 6:</strong>  Fio de pares trançados, cabo coaxial e fibras óticas são tipos de:</br>
                                    </br>

                                    A)  Meios de telecomunicações.</br>

                                    B)  Hardwarede telecomunicações.</br>

                                    C)  Processadores de comunicação.</br>

                                    D)  Topologias de rede.</br>
                                    ...
                                    <p><strong>Questão 7:</strong> Assinale a alternativa que não apresente recurso característico do Excel:</br>
                                    </br>

                                    A)  Montagem de planilhas e grades de cálculo e gráficos.</br>

                                    B)  Manipulação de imagens.</br>

                                    C)  Produção de calendários.</br>

                                    D)  Controle de estoque.</br>

                                    E)  Compartilhamento de dados.</br>
                                    
                                    </br>

                                    <p>

                                    <p><strong>Questão 8:</strong> O tipo de memória gravada pelo fabricante com instruções predefinidas é denominada:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 9:</strong> A definição de sistema é:</br>
                                    </br>

                                    A)  Conjunto de dados integrantes e correlacionados a um objetivo.</br>

                                    B)  Conjunto de dados integrantes e direcionados a um objetivo.</br>

                                    C)  Conjunto de banco de dados relacionais.</br>

                                    D)  Conjunto de partes de dados integrados a um objetivo.</br>

                                    E)  Conjunto de partes integrantes e integradas com um mesmo objetivo.</br>
                                    
                                    </br>

                                    </p>

                                    <p><strong>Questão 10:</strong> Quando falamos de processadores, é certo afirmar:</br>
                                    </br>

                                    A)  A Internet aumentou a velocidade dos sistemas de informações.</br>

                                    B)  Não existe diferença entre eles.</br>

                                    C)  O hardwareé responsável pela leitura e execução dos sistemas, dos programas e do processamento eletrônico dos dados.</br>

                                    D)  Passaram a ser mais seguros com o advento dos microcomputadores.</br>

                                    E)  Estão cada vez mais caros e multiaplicacionais.</br>
