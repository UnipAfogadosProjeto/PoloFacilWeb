<?php session_start(); 
    ...
    $bread = '/ Provas / Gestão em Logística';
    $active = ['', '', ''];
                        ...
                        <div class="hpanel email-compose mailbox-view">
                            ...
                            <div class="border-top border-left border-right bg-light">
                                <div class="p-m custom-address-mailbox">
                                    ...
                                    <div>
                                       <strong><span class="font-extra-bold">Código da Prova: </span> 18807956105</strong>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <strong><span class="font-extra-bold">II -Questões discursivas –valendo  5,00 pontos Gerada em: 04/06/2018 17:47:09</span></strong>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body panel-csm">
                                <div>
                                    ...
                                    <p><strong>Questão 1:</strong> A política monetária consiste na gestão e controle do crédito. A gestão e controleda moeda e do crédito permitem ao governo:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 3:</strong> As externalidades acrescem ou decrescem os custos totais de agentes econômicos.Identifique, entre as alternativas a seguir, a que pode ser tida como negativa no “resultado líquido” entre os custos e os benefícios sociais, comparativamente aos privados:</br>
                                    </br>

                                    A) Aumento dos custos do fator utilizado na produção de um certo bem (X).</br>

                                    B) Diminuição da renda líquida auferida.</br>

                                    C) Instalação de usina hidroelétrica.</br>

                                    D) Abertura de fábrica de celulose na cabeceira de um rio regional, sem controles específicos dos dejetos e combates à poluição.</br>

                                    E) Redução das taxas inflacionárias da região ou do país.</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 4:</strong> Até que ponto é conveniente a produção de determinado bem (X)?</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 5:</strong> Diante o fracasso do Plano Cruzado, outra experiência de estabilização o governo Sarney experimentaria, agora com o chamado Plano Bresser. Sobre esse Plano, assinale a alternativa correta.</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 7:</strong> Leia atentamente o texto abaixo acerca da atividade econômica informal, como se tivesse sido publicada em algum jornal:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 8:</strong> (FGV 2010, SEAD-AP, Auditor da Receita Federal, prova 1, adaptada). Com relação à mensuração do PIB de uma economia, avalie as seguintes afirmativas:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 1:</strong> Qual a principal diferença entre PIB e PNB?</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 2:</strong> Caso exista inflação em uma economia qualquer, de que forma o governo pode utilizar a política monetária para frear o processo?</br>
