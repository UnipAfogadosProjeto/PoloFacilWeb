                        ...
                        <div class="hpanel email-compose mailbox-view">
                            ...
                            <div class="border-top border-left border-right bg-light">
                                <div class="p-m custom-address-mailbox">
                                    ...
                                    <div>
                                       <strong><span class="font-extra-bold">Código da Prova: </span> 18587562442</strong>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                     ...
                                     <div>
                                        ...
                                        <strong><span class="font-extra-bold">II -Questões discursivas –valendo  5,00 pontos Gerada em: 04/06/2018 15:11:20</span></strong>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body panel-csm">
                                <div>
                                    ...
                                    <p>Disciplina: 684560 - Gestão de Recursos Naturais</p>

                                    <p><strong>Questão 1:</strong> A Revolução Industrial foi um conjunto de mudanças que aconteceram na Europa nos séculos XVIII e XIX. As duas principais particularidades dessa revolução foram a substituição do trabalho artesanal pelo assalariado e o uso das máquinas. A principal fonte de energia da época era:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 2:</strong> Várias análises são realizadas nas águas dos mananciais e nas estações de tratamento, garantindo o padrão de qualidade que chega ao consumidor. A principal análise é a que identifica o despejo de esgoto nos corpos de água. Estas análises identificam a presença de microrganismos patogênicos na água.</br>
                                    </br>

                                    A presença de esgoto na água é identificada por:</br>
                                    </br>

                                    A) Coloração alterada.</br>
                                    ...
                                    E) Coliformes fecais.</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 3:</strong> Recurso natural é qualquer insumo de que os organismos, populações e ecossistemas necessitam para a sua manutenção. Portanto, recurso natural é algo útil,  constituindo formas de energia ou de matéria disponíveis na Terra e que podem ser utilizadas pela humanidade. </br>
                                    </br>

                                    Assinale a alternativa que apresenta um exemplo de recurso natural renovável e um não renovável.</br>
                                    </br>

                                    A) Gasolina e álcool.</br>

                                    B) Carvão e pescado.</br>

                                    C) Vento e petróleo.</br>

                                    D) Óleo diesel e gás natural.</br>
                                    ...
                                    <p><strong>Questão 4:</strong> O tipo de solo encontrado em um lugar vai depender de vários fatores: o tipo de rocha matriz que o originou, o clima, a quantidade de matéria orgânica, a vegetação que o recobre e o tempo que levoupara formar-se. Na superfície terrestre, podemos encontrar diversos tipos de solo. Cada um deles possui características próprias, tais como densidade, formato, cor, consistência e formação química. Para estudar o perfil do solo, dividimo-lo em camadas horizontais que mostram sua formação. Assinale a alternativa correta com a classificação da camada de rocha alterada e húmus, onde se fixa a maior parte das raízes:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 5:</strong> O Conselho Nacional de Meio Ambiente (CONAMA), na resolução 275/01, orienta cores-padrão, a fim de identificar e segregar os resíduos sólidos. Assinale a alternativa que relaciona corretamenteas cores designadas para plástico, papel e vidro, respectivamente:</br>
                                    </br>

                                    A) Amarelo, roxo e marrom.</br>

                                    B) Verde, amarelo e branco.</br>

                                    C) Vermelho, azul e verde.</br>

                                    D) Azul, verde, laranja.</br>

                                    E) Marrom, laranja e amarelo.</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 6:</strong> Leia atentamente o trecho a seguir: O desenvolvimento de energias alternativas vem crescendo mundialmente devido às previsões de esgotamento das reservas de combustíveis fósseis. O Brasil é pioneiro na utilização da biomassa para obtenção de energia. O Brasil é pioneiro na produção de:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 7:</strong> Os maiores assuntos de problemática ambiental têm causas divulgadas e discutidas, as quais estão expostas a seguir:</br>
                                    </br>

                                    I.O avanço da fronteira agrícola, as espécies exóticas invasoras, a super exploração de recursos naturais, a sobre pesca.</br>

                                    II.As mudanças climáticas globais, as queimadas naturais e antrópicas, a falta de monitoramento ambiental, poluição.</br>
                                    </br>

                                    São problemas referentes aos exemplos dados nas sentenças I e II:</br>
                                    </br>

                                    A) Extinção e esgotamento sanitário.</br>

                                    B) Acidentes ambientais, destruição da camada de ozônio.</br>

                                    C) Espécies invasoras e acidentes nucleares.</br>

                                    D) Ameaças à biodiversidade e aquecimento global.</br>

                                    E) Aquecimento global e desmatamento.</br>
                                    </br>

                                    </p>


                                    <p><strong>Questão 8:</strong> A erosão é um grande problema associado ao solo. A respeito desta problemática, analiseas afirmações a seguir:</br>
                                    </br>

                                    I.Atividades de mineração, de forma desordenada, também podem provocar erosão. Ao adicionar uma grande quantidade de terra de uma jazida de minério, os solos próximos podem perder sua estrutura de sustentação.</br>

                                    II.Pela ação da natureza, as chuvas são as principais recuperadoras da erosão. Ao atingir o solo, em grande quantidade, provoca deslizamentos, infiltrações e mudanças na consistência do terreno.</br>

                                    III.A ação antrópica pode ser um agente provocador de erosões. Ao retirar a cobertura vegetal de um solo, este perde sua consistência, pois a água , que antes era absorvida pelas raízes das árvores e plantas, passa a infiltrar no solo. Esta infiltração pode causar a instabilidade do solo.</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 1:</strong>  A desigualdade social sempre foi um problema a margem da sociedade. A população carente de educação, carente de alimentação e de emprego se sujeita a morar em condições precárias, em locais de difícil acesso e vivem com medo das chuvas, que podem vitimá-las como uma verdadeira catástrofe. Porque as áreas de encostas, muitas vezes ocupadas irregularmente, são consideradas áreas de risco?</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 2:</strong> Quando levamos em consideração o tamanho das partículas que compõem o solo, temos a classificação granulométrica ou textural, identificando a pedra, o cascalho, a areia e o silte ou limo, cujas partículas vão diminuindo. Raramente, um solo é constituído de uma só das frações definidas, o comumé uma combinação com diferentes porções. Quais são as classificações do solo? Explique cada tipo de solo.</br>
