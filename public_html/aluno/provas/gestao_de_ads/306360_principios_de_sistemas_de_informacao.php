                        ...
                        <div class="hpanel email-compose mailbox-view">
                            ...
                            <div class="border-top border-left border-right bg-light">
                                <div class="p-m custom-address-mailbox">
                                    ...
                                    <div>
                                       <strong><span class="font-extra-bold">Código da Prova: </span> 18201298648</strong>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                     ...
                                     <div>
                                        <strong><span class="font-extra-bold">I -Questões objetivas –valendo  10,00 pontos Gerada em: 04/06/2018 17:02:32</span></strong>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body panel-csm">
                                <div>
                                    ...
                                    <p><strong>Questão 1:</strong> Complete a lacuna com a melhor alternativa apresentada abaixo: ___________________ é uma rede dentro de uma organização que utiliza tecnologias da Internet para criar um ambiente, como o daquela rede dentro da empresa, possibilitando o intercâmbio de informações, comunicações, colaborações e suporte aos processos de negócios.</br>
                                    </br>

                                    A) Rede de telecomunicações.</br>

                                    B) Sistema de Computação.</br>
                                    ...
                                    <p><strong>Questão 2:</strong> Em um computador, o softwareé classificado como a parte lógica, cuja função é fornecer instruções para o hardware. Ele pode ser classificado como:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 3:</strong> Os componentes de um sistema são: entrada, processamento, saída e realimentação. Assim,de quantos tipos pode ser a realimentação ou feedback? </br>
                                    </br>
                                    ...
                                    <p><strong>Questão 6:</strong> As bases de dados são estruturas complexas de armazenagem de dados e normalmente se apresentam em três modelos: hierárquico, em rede e relacional. O modelo hierárquico apresenta os dados na forma de:</br>
                                    </br>
                                    ...
                                    E) Árvore descendente.</br>
                                    </br>
                                    </p>


                                    <p><strong>Questão 7:</strong> Os sistemas de informação têm papel essencial na organização. Qual dos relacionados a seguir é função dos sistemas de informação?</br>
                                    </br>

                                    A) Uma importante contribuição para a eficiência operacional, produtividade e atendimento ao cliente.</br>

                                    B) Importante fonte de apoio para tomada de decisão gerencial. </br>

                                    C) Importante no desenvolvimento de produtos e serviços de valor agregado que geram vantagens competitivas para a organização.</br>

                                    D) Elemento-chave dos recursos, infraestrutura e capacidades das empresas de e-business.</br>
                                    ...
                                    <p><strong>Questão 8:</strong> O desenvolvimento de sistemas demandará do gerente de projetos uma capacidade de liderança, metodologia e uma organização de trabalho para que todas as fases sejam cumpridas com êxito em prol do sucesso do projeto. Não é função do gerente de projetos no desenvolvimento de sistemas:</br>
                                    </br>

                                    A) Delegar funções.</br>

                                    B) Montar cronogramas.</br>

                                    C) Verificar a eficiência das rotinas de programação do sistema.</br>

                                    D) Cuidar do orçamento e dos gastos do projeto.</br>

                                    E) Certificar-se de que o projeto atenda aos requisitos do usuário.</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 9:</strong> A ideia da ______________ é melhorar a comunicação entre os funcionários e parceiros, interligando fornecedores e clientes de fora da corporação, além de acumular uma base de conhecimento que possa ajudar os funcionários a criar novas soluções. Esse conceito refere-se a:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 10:</strong> A UCP é subdividida em quais partes?</br>
                                    </br>

                                    A) ULA, UC e memória.</br>

                                    B) URA, acesso direto e acesso aleatório.</br>

                                    C) Unidade de fita, unidade de disco e unidade de cabo.</br>

                                    D) Unidade de ventoinha, unidade larga, unidade estreita.</br>

                                    E) As partes dependem do tipo de UCP.</br>
