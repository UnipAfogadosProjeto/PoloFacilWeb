                        ...
                        <div class="hpanel email-compose mailbox-view">
                            ...
                            <div class="border-top border-left border-right bg-light">
                                <div class="p-m custom-address-mailbox">
                                    ...
                                    <div>
                                       <strong><span class="font-extra-bold">Código da Prova: </span> 18282411779</strong>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                     ...
                                     <div>
                                        <strong><span class="font-extra-bold">I -Questões objetivas –valendo  10,00 pontos Gerada em: 21/05/2018 13:59:48</span></strong>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body panel-csm">
                                <div>
                                    ...
                                    <p><strong>Questão 1:</strong> Leia com atenção as afirmativas:</br>
                                    </br>

                                    I -As transformações que ocorreram nos séculos XII e XIV mudaram a concepção de mundo do homem ocidental.</br>

                                    II -Os pensadores no século XVI encontravam antigas doutrinas de cunho filosófico e científico formuladas pela civilização greco-romana.</br>

                                    III -No século XVI, praticamente tudo foi contestado, desde a unidade política e religiosa da Europa.</br>

                                    IV -Com os navegadores cruzando os mares e descobrindo novos povos e culturas, houve questionamento das verdades até então estabelecidas pela Idade Média. </br>
                                    </br>
                                    ...
                                    B) As alternativas II e III estão corretas.</br>

                                    C) As alternativas I e IV estão corretas.</br>

                                    D) As alternativas II e IV estão corretas.</br>
                                    ...
                                    <p><strong>Questão 3:</strong> Leia com atenção as afirmativas:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 4:</strong> Para Nietzsche, o mundo é uma espécie de caos e apenas __________ pode transformar a desordem em beleza e tornar aceitável aquilo que há de mais aterrador na condição humana. Assinale aalternativa que completa a frase.</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 5:</strong> Como aluno de Platão, _________________________ discordava de uma parte fundamental da filosofia do seu mestre. Enquanto Platão concebia dois mundos existentes, um aprendido pelos sentidos humanos, em constante mutação, e o outro concebido como sendo das ideias, acessível somente pelo pensamento intelectual, imutável e atemporal, seu aluno contemplava apenas a existência do mundo em que vivemos, alegando que aquilo que estava além da experiência humana não poderia significar nada para o homem.</br>
                                    </br>

                                    Assinale a alternativa que preenche corretamente a frase acima:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 6:</strong> Quais os filósofos que formaram a tríade grega?</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 7:</strong> O pensamento de Augusto Comte se baseava no:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 8:</strong> Como os pontos centrais do pensamento de Michel Foucault podem ser resumidos?</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 9:</strong> O motor da história para Marx é:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 10:</strong> O filósofo ________________ é considerado o primeiro pensador moderno.</br>
                                    </br>
