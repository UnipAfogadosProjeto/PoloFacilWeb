                        ...
                        <div class="hpanel email-compose mailbox-view">
                            ...
                            <div class="border-top border-left border-right bg-light">
                                <div class="p-m custom-address-mailbox">
                                    ...
                                    <div>
                                       <strong><span class="font-extra-bold">Código da Prova: </span> 18916328706</strong>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <strong><span class="font-extra-bold">II -Questões discursivas –valendo  5,00 pontos Gerada em: 14/06/2018 16:55:16</span></strong>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body panel-csm">
                                <div>
                                    ...
                                    <p><strong>Questão 1:</strong> Questão 1: O serviço social, antes de ocupar espaço no campo universitário, já existia, como prática social, para responder às demandas do sistema capitalista no atendimento da questão social. Sobre esse contexto, coloque (V) para as assertivas verdadeiras e (F) para as falsas, marcando, em seguida, a alternativacorreta.</br>
                                    </br>

                                    (   ) A burguesia utilizou estratégias para conter as reivindicações dos trabalhadores, direcionando as lutas populares para o âmbito da legislação burguesa.</br>

                                    (   ) A legislação burguesa, por atender todas as reivindicações dos trabalhadores, consegue conter a luta operária por melhores condições de vida.</br>

                                    (   ) O grupo hegemônico (burguesia) levou a luta dos trabalhadores para o campo ideológico, visando instaurar mecanismos de intervenção para dar continuidade ao desenvolvimento do capital.</br>

                                    (   ) O serviço social surgiu como prática social para difundir a ideologia da classe dominante e,assim, contribuir para a consolidação do sistema capitalista.</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 2:</strong> Adaptado (ENADE 2007) Analise as afirmativas a seguir:</br>
                                    </br>

                                    I -Na expansão monopolista, as funções políticas do Estado burguês articulam-se organicamente comas suas funções econômicas.</br> 

                                    II -O Estado condensa os interesses comuns de toda a sociedade.</br>
                                    </br>

                                    A esse respeito, é possível concluir que:</br>
                                    </br>

                                    A) As duas afirmativas são verdadeiras, e a segunda justifica a primeira.</br>

                                    B) As duas afirmativas são verdadeiras, e a segunda não justifica a primeira.</br>

                                    C) A primeira afirmativa é verdadeira, e a segunda é falsa.</br>

                                    D) A primeira afirmativa é falsa, e a segunda é verdadeira.</br>
                                    ...
                                    <p><strong>Questão 3:</strong> O homem tem a capacidade de transformar conscientemente objetos para satisfazer seus desejos (pessoais ou não). Tal ação é chamada de:</br>
                                    </br>

                                    A) Antropocentrismo.</br>
                                    ...
                                    <p><strong>Questão 5:</strong> A práxis, como vimos, é uma categoria essencial no fazer profissional cotidiano do assistente social. Sobre a práxis, é incorreto afirmar.</br>
                                    </br>

                                    A) Diz respeito à atitude neutra que o assistente social deve ter na execução de suas tarefas cotidianas.</br>

                                    B) Define-se pelo conjunto de atividades que objetivam a modificação de uma determinada realidade e que se traduz em uma transformação social.</br>

                                    C) Não está dissociada da ação prática. Porém, para constituí-la, é preciso que as ações estejam articuladas e estruturadas como um todo.</br>

                                    D) Para Marx, a sua finalidade é a transformação real e objetiva do mundo natural e social, visando à satisfação das necessidades humanas.</br>

                                    E) Não diz respeito à atitude neutra que o assistente social deve ter na intervenção de suas tarefas cotidianas.</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 6:</strong> Ao reproduzirmos a desconfiguração do pensamento em Marx, possivelmente estamos sendo influenciados pelo/a:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 7:</strong> Segundo Castel, a vida dos proletários pode ser influenciada negativamente pela flexibilidade externa. Qual das alternativas explica tal afirmação?</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 8:</strong> (ENADE -2007) A análise do significado social do serviço social no processo de reprodução das relações sociais salienta o caráter contraditório da profissão. Ela reproduz, pela mesma atividade, interesses contrapostos que convivem em tensão -demandas do capital e do trabalho -e só pode fortalecer um ououtro polo pela mediação de seu oposto. De que decorre esse caráter contraditório da atuação profissional?(Fonte de pesquisa: http://www.pucrs.br/edipucrs/enade/servicosocial2007.pdf)</br>
                                    </br>

                                    A) Da intencionalidade do assistente social.</br>

                                    B) Da condução da atuação profissional.</br>

                                    C) Da pressão dos empregadores.</br>

                                    D) Da relação de classes.</br>

                                    E) Das demandas dos usuários.</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 1:</strong>  Explique cada uma das dimensões de competências do serviço social: ético-política, técnico-operativa e teórico-metodológica.</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 2:</strong> Descreva três áreas de atuação do Serviço Social Contemporâneo. </br>
