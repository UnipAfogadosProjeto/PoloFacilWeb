<?php session_start(); 
    ...
    $bread = '/ Provas / Serviço Social / Ética Profissional';
    $active = ['', '', ''];
...
<head>
    ...
    <title>Provas - Serviço Social - Ética Profissional | Polo Fácil</title>
                        ...
                        <div class="hpanel email-compose mailbox-view">
                            ...
                            <div class="border-top border-left border-right bg-light">
                                <div class="p-m custom-address-mailbox">
                                    ...
                                    <div>
                                       <strong><span class="font-extra-bold">Código da Prova: </span> 18592957380</strong>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                     ...
                                     <div>
                                        <strong><span class="font-extra-bold">I -Questões objetivas –valendo  10,00 pontos Gerada em: 08/06/2018 15:06:38</span></strong>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body panel-csm">
                                <div>
                                    ...
                                    <p><strong>Questão 1:</strong> O Artigo 3° do Código de Ética determina os deveres do Assistente Social, entre eles:O Artigo 3° do Código de Ética determina os deveres do Assistente Social, entre eles:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 2:</strong> O Código de Ética cita 11 princípios fundamentais que materializam:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 3:</strong> O ser humano sobrevive agindo sobre a natureza; assim, para garantir a convivência em grupo, estabelece:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 4:</strong> O Assistente Social pode ser processado por exercício ou prática ilegal da profissão. Para que o processo seja instaurado é preciso:</br>
                                    </br>

                                    A) verificar o Código de Ética.</br>

                                    B) que exista uma denuncia formal por escrito.</br>

                                    C) informar órgãos fiscalizadores.</br>

                                    D) saber o n° do CRESS do profissional. </br>

                                    E) fazer Boletim de Ocorrência. </br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 5:</strong> O profissional legalmente habilitado à prestação de serviço de natureza técnico-científica, com liberdade de execução é um profissional:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 6:</strong> Que autores entendem  que o Serviço Social, mesmo com sua regulamentação, não tem características de profissão liberal por  ainda ser um trabalho assalariado.</br>
                                    </br>

                                    A) Vazquez e Martinelli.</br>

                                    B) Iamamoto  e Carvalho.</br>

                                    C) Carvalho e Martinell.</br>

                                    D) Iamamoto e Vasquez.</br> 

                                    E) Sposati e Martinelli. </br> 
                                    </br>

                                    </p>

                                    <p><strong>Questão 7:</strong>  A composição que segue: Presidente, vice-presidente, 1° secretário, 2° secretário, 1° tesoureiro, 2° tesoureiro e 3 membros efetivos do Conselho Fiscal, é a constituição do:</br>
                                    </br>

                                    A) Conselho Federal de Serviço Social.</br>

                                    B) Conselho Pleno.</br>

                                    C) Conselho Regional de Serviço Social.</br>

                                    D) Conselho Consultivo.</br>

                                    E) do Colegiado do CRESS. </br>
                                    </br>

                                    <p>

                                    <p><strong>Questão 8:</strong> Quem  é o autor(a) que afirma: “(...)  A função social da moral é a de regular as açõesdos indivíduos nas suas relações mútuas, ou as do indivíduo com a comunidade, visando a preservar a sociedade no seu conjunto, ou no seio dela, a integridade de um grupo social.”</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 9:</strong> Em qual década foi instituída a Lei que regulamentou o exercício da profissão e criou oConselho Federal de Assistentes Sociais(CFAS) e os Conselhos Regionais(CRAS)</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 10:</strong> Historicamente, uma sociedade substitui a outra. Essa mudança substitui a _______ da sociedade.</br>
                                    </br>
