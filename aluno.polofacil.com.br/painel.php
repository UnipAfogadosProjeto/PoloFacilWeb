                ...
                <div class="row">
                        ...
                        <div class="hpanel widget-int-shape responsive-mg-b-30">
                            <div class="panel-body">
                                ...
                                <div class="m-t-xl widget-cl-1">
                                    <button onclick="window.location.href = 'https://ava.ead.unip.br/'"; class="btn btn-success widget-btn-1 btn-sm">Acessar</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="hpanel widget-int-shape responsive-mg-b-30">
                            <div class="panel-body">
                                ...
                                <div class="m-t-xl widget-cl-2">
                                    <button onclick="window.location.href = 'https://gfa.unip.br/aluno/#/login'"; class="btn btn-success widget-btn-1 btn-sm">Acessar</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="hpanel widget-int-shape responsive-mg-b-30 res-tablet-mg-t-30 dk-res-t-pro-30">
                            <div class="panel-body">
                                <div class="stats-title pull-left">
                                    <h4>Postar de Atividades</h4>
                                </div>
                                <div class="stats-icon pull-right">
                                    <i class="educate-icon educate-department"></i>
                                </div>
                                <div class="m-t-xl widget-cl-2">
                                    <button onclick="window.location.href = 'http://trabalhosacademicos.unip.br/Entrega/Default.aspx'"; class="btn btn-success widget-btn-1 btn-sm">Acessar</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="hpanel widget-int-shape res-tablet-mg-t-30 dk-res-t-pro-30">
                            <div class="panel-body">
                                ...
                                <div class="m-t-xl widget-cl-2">
                                    <button onclick="window.location.href = 'http://atendimento.unip.br/Alunos/Autenticacao'"; class="btn btn-success widget-btn-1 btn-sm">Acessar</button>
                                </div>
                            </div>
                        </div>
                    </div>
