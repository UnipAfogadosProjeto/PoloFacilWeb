...
<head>
    ...
    <title>Provas - Pedagogia - Página 2 | Polo Fácil</title>
                        ...
                        <div class="product-status-wrap">
                            ...
                            <div class="asset-inner">
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="18270416819_orientacao_e_praticas_em_projetos_na_infancia.php"class="pd-setting"><i class="fa fa-book" aria-hidden="true"></i> Orientação e Práticas em Projetos na Infância</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <a href="18282411779_historia_do_pensmento_filosofico.php"class="pd-setting"><i class="fa fa-book" aria-hidden="true"></i>  História do Pensamento Filosófico</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <a href="18679851469_orientacao_em_supervisao_escolar_e_orientacao_educacional.php"class="pd-setting"><i class="fa fa-book" aria-hidden="true"></i> Orientação em Supervisão Escolar e Orientação Educacional</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <a href="18684181557_orientacao_em_praticas_e_projetos_de_ensino_fundamental.php"class="pd-setting"><i class="fa fa-book" aria-hidden="true"></i> Orientação em Práticas e Projetos de Ensino Fundamental</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <a href="18855224548_homem_e_sociedade.php"class="pd-setting"><i class="fa fa-book" aria-hidden="true"></i> Homem e Sociedade</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <a href="18965404265_politica_e_organizacao_da_educacao_basica.php"class="pd-setting"><i class="fa fa-book" aria-hidden="true"></i> Política e Organização da Educação Básical</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <a href="18491690610_relacoes_etnico_raciais_no_brasil.php"class="pd-setting"><i class="fa fa-book" aria-hidden="true"></i> Relações Étnico - Raciais no Brasil</a>
                                        </td>
                                    </tr>
                                </table>
