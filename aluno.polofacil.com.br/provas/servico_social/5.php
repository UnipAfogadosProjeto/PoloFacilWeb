...
<head>
    ...
    <title>Provas - Serviço Social | Página 5 | Polo Fácil</title>
                        ...
                        <div class="product-status-wrap">
                            ...
                            <div class="asset-inner">
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="19315682385_psicologia_do_desenvolvimento_clico_vital.php"class="pd-setting"><i class="fa fa-book" aria-hidden="true"></i> PSICOLOGIA DO DESENVOLVIMENTO: CICLO VITAL</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <a href="19394782244_fund_hist_teoricos_e_metodos_do_servico_social.php"class="pd-setting"><i class="fa fa-book" aria-hidden="true"></i> FUND. HIST. TEÓRICOS E METOD DO SERV. SOCIAL - Prova 2</a>
                                        </td>
                                    </tr>

                                    <tr>
                                        <td>
                                            <a href="19640376523_planejamento_e_gestao_social.php"class="pd-setting"><i class="fa fa-book" aria-hidden="true"></i> PLANEJAMENTO E GESTÃO SOCIAL</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <a href="19820392095_comunicacao_e_expressao.php"class="pd-setting"><i class="fa fa-book" aria-hidden="true"></i> COMUNICAÇÃO E EXPRESSÃO</a>
                                        </td>
                                    </tr>      
                                </table>
