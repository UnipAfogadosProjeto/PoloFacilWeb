                        ...
                        <div class="hpanel email-compose mailbox-view">
                            ...
                            <div class="border-top border-left border-right bg-light">
                                <div class="p-m custom-address-mailbox">
                                    ...
                                    <div>
                                       <strong><span class="font-extra-bold">Código da Prova: </span> 18338467823</strong>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <strong><span class="font-extra-bold">II -Questões discursivas –valendo  5,00 pontos Gerada em: 14/06/2018 18:08:04</span></strong>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body panel-csm">
                                <div>
                                    ...
                                    <p><strong>Questão 1:</strong> Segundo Castel, a vida dos proletários pode ser influenciada negativamente pela flexibilidade externa. Qual das alternativas explica tal afirmação?</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 2:</strong> Sobre as áreas de atuação do assistente social no primeiro, segundo e terceiro setores,marque V para as alternativas verdadeiras e F para as falsas.</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 3:</strong> Em relação ao projeto ético-político do serviço social, assinale V ou F e depois indique a sequência correta.</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 4:</strong> Ao planejar uma intervenção, o Assistente Social deve:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 6:</strong> O homem tem a capacidade de transformar conscientemente objetos para satisfazer seus desejos (pessoais ou não). Tal ação é chamada de:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 7:</strong> A teoria de Marx sobre conhecimento teórico trabalha com qual objeto?</br>
                                    </br>

                                    A) Abstração imaginária do saber.</br>

                                    B) Modalidade peculiar de conhecimento.</br>

                                    C) Segmento contraditório da realidade.</br>

                                    D) Pode ou não ser utilizado em uma intervenção crítica.</br>

                                    E) Todas as opções anteriores estão corretas.</br>
                                    </br>

                                    </p>


                                    <p><strong>Questão 8:</strong>  Ao reproduzirmos a desconfiguração do pensamento em Marx, possivelmente estamos sendo influenciados pelo/a:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 1:</strong> Iniciada na Inglaterra na segunda metade do século XVIII, a Revolução Industrial imprimiu profundas e duradouras marcas na sociedade e consolidou duas classes antagônicas. Quais são essas classes sociais?</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 2:</strong> O neoliberalismo é uma política econômica que envolve vários aspectos. Cite um deles.</br>
