                        ...
                        <div class="hpanel email-compose mailbox-view">
                            ...
                            <div class="border-top border-left border-right bg-light">
                                <div class="p-m custom-address-mailbox">
                                    ...
                                    <div>
                                       <strong><span class="font-extra-bold">Código da Prova: </span> 18704078825</strong>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                     ...
                                     <div>
                                        <strong><span class="font-extra-bold">I - Questões objetivas – valendo 10,00 pontos Gerada em: 04/06/2018 14:40:26</span></strong>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body panel-csm">
                                <div>
                                    ...
                                    <p>Disciplina: 549580 - Informática</p>

                                    <p><strong>Questão 1:</strong> Os firewallssão as principais barreiras contra ataques de invasores às redes de computadores. Há dois tipos de firewall: firewallde filtragem de pacotes e gateways. Qualdas alternativas a seguir NÃO representa uma vantagem do uso de firewallsde filtragem de pacotes?</br>

                                    A)  Simples e flexível, com baixo custo.</br>
                                    B)  Possui bom desempenho se comparado a outros tipos.</br>
                                    C)  Faz um bom gerenciamento de tráfego.</br>
                                    D)  As regras são fáceis de serem criadas.</br>
                                    E)  Não possui autenticação de usuário.</br>
                                    </p>

                                    <p><strong>Questão 2:</strong> Entre os aspectos importantes relativos à segurança de sistemas de informação, inclui-se:</br>

                                    </br>I -A proteção de dados por meio de senhas e criptografia forte</br>

                                    II -A existência de um plano de recuperação de desastres associado a backupsfrequentes.</br>

                                    III -A utilização de firewallsassociada a mecanismos de detecção de intrusão</br>
                                    ...
                                    </br>Das alternativas a seguir, assinale a opção correta:</br>

                                    A)  Nenhuma das afirmativas está correta.</br>
                                    B)  Todas as afirmativas estão corretas.</br>
                                    C)  Apenas as afirmativas I e II estão corretas.</br>
                                    D)  Apenas as afirmativas I e III estão corretas</br>
                                    E)  Apenas as afirmativas II e III estão corretas.</br>
                                    </p>

                                    <p><strong>Questão 3:</strong> O programa Microsoft Word é um softwareque faz parte do pacote de aplicativos Microsoft Office e é utilizado para criar e editar textos como cartas, memorandos e relatórios para finalidades acadêmicas e profissionais. Escolha a alternativa que corresponde à sequência utilizada para executar o Word, no caso de não haver um ícone de atalho disponível na área de trabalho.</br>

                                    A)   Menu Iniciar > Todos os programas > Microsoft Office > Microsoft Word.</br>

                                    B)  Menu Iniciar > Microsoft Office > Programas > Microsoft Word.</br>

                                    C)   Menu Iniciar > Painel de Controle > Programas de Usuários > Word.</br>

                                    D)  Menu Iniciar > Painel de Controle > Todos os Programas > Microsoft Office > Microsoft Word.</br>

                                    E)  Nenhuma das alternativas.Nenhuma das alternativas.</br>
                                    </p>


                                    <p><strong>Questão 4:</strong> Durante uma aula de informática, o professor solicitou aos seus alunos que elaborassemplanilhas eletrônicas utilizando o Microsoft Excel. Como objetivo principal, os alunos deveriam criam uma planilha para auxiliar no controle dos gastos mensais de suas casas, levando-se em consideração as contas de água, energia elétrica, mantimentos e outros gastos, além de considerar os salários de todos os membros da família. Para facilitar a visualização dos resultados calculados, o professor sugeriu aos alunos que criassem uma célula mostrando o saldo total ao final do mês e que a célula ficasse vermelha para saldo negativo e azul para saldo positivo. Qual o nome da ferramenta do Excel que nos permite mudar as cores de texto e de células de forma vinculada ao resultado exibido?</br>
                                    ...
                                    A)  Formatação automática.</br>
                                    B)  Formatação condicional.</br>
                                    C)  Formatação efetiva.</br>
                                    D)  Formatação colorida.</br>
                                    E)  Formatação seletiva.</br>
                                    </p>


                                    <p><strong>Questão 5:</strong> Os protocolos de comunicação utilizam criptografia para garantir a segurança dos dados que são transmitidos. Um usuário de internet pode verificar se está navegando em ambiente seguro para transferência de dados ao observar no seu navegador que o endereço acessado se inicia com:</br>

                                    A)   FTP://.</br>
                                    B)   HTTP://.</br>
                                    C)   Com.br (caso seja um site brasileiro).</br>
                                    D)   Proxy.com.br.</br>
                                    E)   HTTPS://.</br>
                                    </p>


                                    <p><strong>Questão 6:</strong> A Unidade Central de Processamento (UCP), também chamada processador é o elemento responsável por:</br>

                                    A)   Aumentar a potência elétrica do equipamento para maior desempenho.</br>

                                    B)    Executar as instruções de um programa de computador e o fluxo de informações em linguagem de máquina.</br>

                                    C)   Agrupar no centro do hardwaredados que não são úteis para o bom funcionamento do sistema operacional</br>

                                    D)   Ler exclusivamente arquivos de vídeo e som para manter a agilidade da reprodução destes arquivos.</br>

                                    E)   Nenhuma das alternativas anteriores.</br>
                                    </p>


                                    <p><strong>Questão 7:</strong> Existe uma categoria de programas de computador que segue pela internet até os computadores dos usuários e ali passam a recolher seus dados sem seu conhecimento e sua permissão e depois os envia para ambientes externos aos computadores mencionados. São diferentes dos Cavalos de Tróia pelo fato de não terem como objetivo a dominação ou manipulação do sistema do usuário. Qual o nome dado a este tipo de programa?</br>
                                    ...
                                    <p><strong>Questão 8:</strong> Em problemas matemáticos que requerem a otimização de resultados como valores máximos emínimos, podemos utilizar diversas ferramentas disponíveis atualmente, destinadas ao uso comercial eacadêmico. O Microsoft Excel disponibiliza uma ferramenta com esta finalidade. Indique entre as alternativas a seguir qual a ferramenta a ser utilizada para resolver este tipo de problema, seja ele linear ou não linear:</br>
                                    ...
                                    <p><strong>Questão 9:</strong> A palavra modemé a abreviação de modulador/demodulador. O papel de um modulador é a conversão de sinais digitais para analógicos. Várias marcas e modelos de modemestão disponíveis atualmente no mercado em preços variados. Indique a alternativa que caracteriza o papel demodulador de um modem. </br>
                                    </p>

                                     A)  Receber pulsos eletromagnéticos desorganizados e ordená-los para leitura no HD.</br>

                                    B)  Converter sinais digitais para analógicos.</br>

                                    C)  Enviar pulsos eletromagnéticos desorganizados a fim de criptografar senhas e documentos para transmissão segura de dados.</br>

                                    D)  Filtrar e estabilizar sinais recebidos com muitos ruídos vindos de sitesnão confiáveis.</br>

                                    E)  Converter sinais analógicos para sinais digitais.</br>
                                    </p>

                                    <p><strong>Questão 10:</strong> O OpenOffice, também conhecido como BrOffice aqui no Brasil, é formado por um conjuntode aplicativos de código fonte aberto, disponibilizado para diversas plataformas, como Windows, Linux, Mac OS. Tem como objetivo fornecer um aplicativo de baixo custo, com alta qualidade. Qual dos programas do OpenOffice listados a seguir pode ser considerado equivalente ao programa Microsoft Excel pertencente ao pacote Microsoft Office? </br>
                                    </p>
