                        ...
                        <div class="hpanel email-compose mailbox-view">
                            ...
                            <div class="border-top border-left border-right bg-light">
                                <div class="p-m custom-address-mailbox">
                                    ...
                                    <div>
                                       <strong><span class="font-extra-bold">Código da Prova: </span> 18338913660</strong>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <strong><span class="font-extra-bold">II -Questões discursivas –valendo  5,00 pontos Gerada em: 04/06/2018 19:06:02</span></strong>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body panel-csm">
                                <div>
                                    ...
                                    <p>Disciplina: 6306260 - Organização de Computadores</p>

                                    <p><strong>Questão 1:</strong> Existem diversos tipos de memórias ROM. Uma delas, além de poder ser programada, pode ser apagada e depois reprogramada. Isso ocorre com a emissão de luz ultravioleta, e as informações precisam ser apagadas por completo para depois ser realizada a reprogramação. Essa afirmação se refere à memória:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 2:</strong> Descreveu a máquina analítica e é considerado o avô do computador:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 4:</strong> A característica predominante dos processadores RISC era:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 5:</strong> As DRAMs usam:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 6:</strong> O disco magnético, também conhecido por disco rígido ou HD(Hard Disk),é um tipo de memória:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 7:</strong>  Desde a primeira geração de computadores, a máquina de von Neumann é a estrutura básicade quase todos os computadores digitais da atualidade. Assinale a opção que nãorepresenta um componente dessa máquina:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 8:</strong> “Usam laserde três potências diferentes. Em alta potência, o laserfunde a liga fazendo-a passar do estado cristalino de alta reﬂetividade para o estado amorfo de baixa reﬂetividade, a fim de representar uma depressão. Em potência média, a liga se funde e volta novamente ao seu estado natural cristalinopara se tornar novamente um plano. Em baixa potência, o estado do material é sondado (para leitura), mas não ocorre transição de fase.” Esse conceito se refere ao: </br>
                                    </br>
                                    ...
                                    <p><strong>Questão 1:</strong> Técnica de dividir a execução da instrução em várias partes, cada uma sendo manipulada por uma parte específica do processador.  A qual técnica esse conceito se refere?</br>
                                    </br>
