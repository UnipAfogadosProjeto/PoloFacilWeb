                        ...
                        <div class="hpanel email-compose mailbox-view">
                            ...
                            <div class="border-top border-left border-right bg-light">
                                <div class="p-m custom-address-mailbox">
                                    ...
                                    <div>
                                       <strong><span class="font-extra-bold">Código da Prova: </span> 18410656431</strong>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                     ...
                                     <div>
                                        <strong><span class="font-extra-bold">I -Questões objetivas –valendo  10,00 pontos Gerada em: 23/05/2018 12:02:31</span></strong>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body panel-csm">
                                <div>
                                    ...
                                    <p>Disciplina: 540240 - Formaçao de Preços de Venda</p>

                                    </br>Permitido o uso de calculadora.</br>

                                    <p><strong>Questão 1:</strong> No tocante à segmentação de clientes pela percepção de valor, um típico “comprador de preço” se situa no quadrante que caracteriza:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 2:</strong> Em suas pesquisas de mercado para o lançamento do produto de limpeza de codinome VMC, a Smelt & Lichtz observou que não houve diferenciação significativa sobre as intenções de compra a preço 100 e a preço 170. Após o uso do produto, no entanto, ocorreram diferenças substanciais entre os preços base 100 e base 170, o que justificaria, por si só:</br>
                                    </br>

                                    A) uma prova cabal de que o produto deveria ser lançado a um preço mais caro ainda.

                                    B) uma maior aceitação a um preço mais elevado do que o que estava previsto.

                                    C) que o efeito preço-qualidade promove, muitas vezes, a aquisição do produto.

                                    D) o lançamento do produto a um preço mais elevado.

                                    E) a honestidade das respostas do consumidor.
                                    </br>

                                    </p>

                                    <p><strong>Questão 3:</strong> Com relação à curva de custo marginal, indique  a alternativa errada.</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 4:</strong> Ao estabelecer um custo baseado em hora-máquina, utilizada no processo produtivo, o gestor de custos deve ficar atento:</br>
                                    </br>

                                    A) à incidência de impostos sobre os insumos utilizados no processo produtivo, considerando-os na mesma proporção do custo em relação ao preço de venda.

                                    B) ao nível de ocupação da planta industrial, já que o dimensionamento básico considera plena utilização das máquinas.

                                    C) ao nível de ocupação da força de trabalho, já que a mão de obra direta não faz parte do custo hora-máquina.

                                    D) à apropriação do custo contábil na formulação do custo hora-máquina, para fins de reposição do ativo utilizado.

                                    E) ao rateio das despesas financeiras que possam incidir sobre o custo daí decorrente.
                                    </br>

                                    </p>

                                    <p><strong>Questão 5:</strong> No tocante ao apreçamento estratégico, uma pergunta reativa:</br>
                                    </br>

                                    A) configura um posicionamento que sucede uma constatação do mercado.

                                    B) configura um posicionamento que precede uma constatação do mercado.

                                    C) configura uma tomada de consciência de um problema que pode ser facilmente contornado, quando da formação do preço do bem ou serviço.

                                    D) quase sempre indica uma reação exagerada da força de vendas em relação à dificuldade de comercialização.

                                    E) manifesta-se toda vez que há uma antecipação de algum problema mercadológico.
                                    </br>

                                    </p>

                                    <p><strong>Questão 6:</strong> Dentre as opções para reação à competição em preço, se o concorrente é estrategicamente mais fraco e a reação de preço é justificada pelo custo, a empresa deve:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 7:</strong> Qual, dentre os seguintes fatores, não provoca deslocamentos da curva de demanda?</br>
                                    </br>

                                    A) Variações no poder aquisitivo da sociedade.

                                    B) Mudanças nas atitudes e preferências dos consumidores em relação ao produto.

                                    C) Variações nos preços do produto.

                                    D) Variações nos preços dos produtos similares ou substitutos.

                                    E) Variações nos preços dos produtos complementares
                                    </br>

                                    <p>

                                    <p><strong>Questão 8:</strong> No tocante ao cruzamento das curvas de oferta e de demanda de determinado produto, o preço de equilíbrio define:</br>
                                    </br>

                                    A) a maximização da satisfação do consumidor e do lucro do produtor.

                                    B) o máximo que os consumidores estão dispostos a pagar por um produto.

                                    C) o mínimo que os produtores estão dispostos a aceitar em pagamento dos produtos oferecidos no mercado.

                                    D) uma situação dificilmente alterável, mesmo a médio prazo.

                                    E) uma situação passageira, que logo se modificará.
                                    </br>

                                    </p>

                                    <p><strong>Questão 9:</strong> A análise do ponto de equilíbrio permite tanto determinar o nível de operação que uma empresa precisa manter para cobrir todos os seus custos operacionais, quanto avaliar a lucratividade associada a vários níveis de venda. O ponto de equilíbrio operacional é definido quando:</br>
                                    </br>
                                    ...
                                    E) a receita total supera o custo total num nível equivalente ao custo marginal.
                                    </br>

                                    </p>

                                    <p><strong>Questão 10:</strong> Observe este gráfico e identifique onde está o Ponto de Equilíbrio (Break Even Point):A) Está no ponto I.</br>
                                    
                                    </br><img src="./img/18410656431_formacao_de_precos_de_venda_img1.jpg"></br>
                                    ...
                                    E) Não há Ponto de Equilíbrio neste gráfico.
