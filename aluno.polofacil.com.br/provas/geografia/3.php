...
<head>
    ...
    <title>Provas - Geografia - Página 3 | Polo Fácil</title>
                        ...
                        <div class="product-status-wrap">
                            ...
                            <div class="asset-inner">
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="19728403539_reorganizacao_do_espaco_mundial.php"class="pd-setting"><i class="fa fa-book" aria-hidden="true"></i> REGIONALIZAÇÃO DO ESPAÇO MUNDIAL: EUROPA/ÀFRICA/ ÁSIAS</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <a href="19771067081_estrutura_e_funcionamento_da_educacao_basica.php"class="pd-setting"><i class="fa fa-book" aria-hidden="true"></i> ESTRUTURA E FUNCIONAMENTO DA EDUCAÇÃO BÁSICA</a>
                                        </td>
                                    </tr>
                                </table>
