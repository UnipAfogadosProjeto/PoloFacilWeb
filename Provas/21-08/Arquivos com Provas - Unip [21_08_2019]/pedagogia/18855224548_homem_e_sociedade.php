                        ...
                        <div class="hpanel email-compose mailbox-view">
                            ...
                            <div class="border-top border-left border-right bg-light">
                                <div class="p-m custom-address-mailbox">
                                    ...
                                    <div>
                                       <strong><span class="font-extra-bold">Código da Prova: </span> 18855224548</strong>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                     ...
                                     <div>
                                        <strong><span class="font-extra-bold">I -Questões objetivas –valendo  10,00 pontos Gerada em: 21/05/2018 13:36:06</span></strong>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body panel-csm">
                                <div>
                                    ...
                                    <p><strong>Questão 2:</strong> Podemos observar que o contato com uma cultura diferente de seu grupo social de origem, pode ter alguns efeitos sobre os indivíduos. Entre esses efeitos está o processo que é conhecido como ACULTURAÇÃO. Esse conceito pode ser explicado como segue:</br>
                                    </br>

                                    A) É a capacidade que uma cultura desenvolve no sentido de manter intactos seus próprios valores e saberes tradicionais, mesmo quando em contato com a diversidade cultural.</br>

                                    B) Pode ser explicado como o processo de tornar os indivíduos membros de um grupo social; todos nós somos modelados de acordo com a expectativa do meio social em que crescemos.</br>

                                    C) Esse conceito descreve a atual situação decorrente da globalização, em que os países do mundo todo se influenciam mutuamente e em igual medida em seus hábitos e valores culturais.</br>

                                    D) É o processo de reforço das tradições de uma cultura, quando todos os indivíduos se recusama ser influenciados por outros grupos sociais, isolando-se culturalmente.</br>

                                    E) É o processo de perda das tradições dentro de um grupo social, quando seus indivíduos passam a adotar sistematicamente um modelo de comportamento e valores de uma cultura alheia, de fora.</br>
                                    
                                    </br>
                                    </p>

                                    <p><strong>Questão 3:</strong>Nesse período, os grupos humanos sobreviveram lascando uma pedra na outra para conseguir objetos pontiagudos e cortantes que serviam como arma de caça, como raspador de alimentos ou que tivessem qualquer utilidade para a vida humana. Essas características se referem ao período denominado:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 4:</strong> Tudo que compartilhamos ao viver em sociedade, e que podemos observar que se repetena maioria dos indivíduos de nosso grupo, é resultado de um processo de aprendizagem da cultura que denominamos:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 5:</strong> A espécie humana apresenta diferenças anatômicas e fisiológicas, porém essas diferenças biológicas não determinam o comportamento das pessoas. Usando como exemplo o caso das mulheres, podemos afirmar que:</br>
                                    </br>

                                    A) O que em algumas culturas é atribuído como atividade feminina, em outras é considerado atividade masculina.</br>

                                    B) Em todas as culturas há o mesmo padrão de definição quanto ao papel atribuído tanto aos homens como às mulheres.</br>

                                    C) Em qualquer cultura tanto homens como mulheres exercem atividades e papeis sociais semelhantes.</br>

                                    D) Os papéis sociais já estão definidos pela constituição biológica tanto de homens como de mulheres.</br>

                                    E) O determinante dos papeis sociais da mulher e do homem são as condições geográficas de cadacultura.</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 6:</strong> Determinismo biológico é a concepção que: </br>
                                    </br>

                                    A) atribui ao ser humano a causa eficiente de tudo, pois é autor psicológico e cultural de suavida.</br>

                                    B) numa de suas frentes, trata das ações humanas como produto de sua constituição genética.</br>

                                    C) trata das ações humanas como produto de seu meio.</br>

                                    D) aborda as relações sociais como determinadas pelo mercado.</br>

                                    E) acredita que os indivíduos são responsáveis pelos seus atos, pois são membros de um contexto cultural.</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 7:</strong> Quanto à “Proibição do incesto”, leia o trecho do livro-texto a seguir e assinale aalternativa que apresente uma afirmação falsa sobre essa noção, para a evolução do ser humano.A proibição do incesto: passagem da natureza para a cultura.</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 8:</strong> Partindo do princípio de que a cultura é uma lente através da qual o homem vê o mundo, pessoas de culturas diferentes usam lentes diferentes e, portanto, têm visões distintas das coisas. Escolha a alternativa correta:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 9:</strong> Sobre o comportamento humano, pode-se afirmar que:</br>
                                    </br>

                                    A) ele é, basicamente, instintivo.</br>

                                    B) ele é inato.</br>

                                    C) apesar de os instintos existirem, os comportamentos são determinados pelo aprendizado.</br>

                                    D) apesar de os instintos existirem, a liberdade absoluta de escolha é a única característica responsável pela nossa maneira de agir.</br>

                                    E) não há limites às ações humanas já que elas são sempre sociais.</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 10:</strong> “Os mais aptos, por estarem mais adaptados têm mais chances de reproduzir e deixaressa carga genética para a próxima geração. Por isso, os indivíduos gerados por esse processo serão aindamais privilegiados a sobreviver, pois já nascem com “vantagens genéticas” e passam mais uma geração adiante essa vantagem adaptativa.” Trata-se da definição de:</br>
                                    </br>
