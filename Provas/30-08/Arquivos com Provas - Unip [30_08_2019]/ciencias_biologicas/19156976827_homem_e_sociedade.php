                        ...
                        <div class="hpanel email-compose mailbox-view">
                            ...
                            <div class="border-top border-left border-right bg-light">
                                <div class="p-m custom-address-mailbox">
                                    ...
                                    <div>
                                       <strong><span class="font-extra-bold">Código da Prova: </span> 19156976827</strong>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                     ...
                                     <div>
                                        <strong><span class="font-extra-bold">I -Questões objetivas –valendo  10,00 pontos Gerada em: 02/04/2019 10:57:09</span></strong>
                                    </div>
                            ...
                            <div class="panel-body panel-csm">
                                <div>
                                    ...
                                    <p><strong>Questão 2:</strong> A espécie humana surgiu devido a mudanças biológicas e ao desenvolvimento da cultura. Dentre as mudanças biológicas que proporcionaram essas diferenças, não estão incluídas:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 3:</strong> “Existe uma tendência em considerar os hábitos e valores de cada cultura como válidos, lógicos e corretos, mesmo quando muito diferentes daqueles que aprendemos em nossa própria cultura”. Essa tendência pode ser denominada de:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 4:</strong> A vida no campo (cultura de base rural) e o trabalho na agricultura (geografia e economia agrárias) podem ser compreendidas pela antropologia. Assinale a questão que apresenta uma abordagem dos elementos citados pela antropologia.</br>
                                    </br>

                                    A) Pode-se perceber a integração simbólica dos aspectos biológicos (ritmos orgânicos do corpo,das sementes e animais empregados), astronômicos (movimento dos astros, como a lua, o sol, as estrelas), geográficos (as formas de relevo e de hidrografia, a relações de distância) e econômicos (valores de uso e de troca dos produtos cultivados), respectivamente, para marcação do tempo, atribuição de significado às localizações, valores dos objetos familiares e para uso ou venda.</br>

                                    B) O preço da terra é um fator limitante à fixação das famílias à terra.</br>

                                    C) Os movimentos pela posse da terra devem ser interpretados política e economicamente.</br>

                                    D) A produção brasileira tem vivido números recordes.</br>

                                    E) O trabalhador do campo sofre muitas dificuldades sazonais, ligadas ao clima e ao consumo. </br>
                                    
                                    </br>

                                    </p>

                                    <p><strong>Questão 5:</strong> Entre as características que encontramos em todas as culturas humanas, é correto apontar:</br>
                                    </br>

                                    A) Que em todas as culturas os crimes são punidos, bem como em todas as culturas a noção de justiça é equivalente; assim, os valores humanos sobre o que pode ser considerado crime são universais, não variam de uma cultura para outra.</br>

                                    B) Toda cultura é acumulativa, seletiva e dinâmica, o que significa dizer que recebemos uma herança cultural que pode ser transformada, bem como selecionamos os costumes e conhecimentos considerados mais importantes para a nossa época.</br>

                                    C) Que é possível encontrarmos alguns traços absolutamente semelhantes e universais, por exemplo, as noções de beleza e feiura, do que é aceito ou reprovado como conduta social; apesar disso outros traços são particulares, de uma única cultura, como por exemplo, os hábitos de consumo de alimentos.</br>

                                    D) As características básicas da cultura são a adaptação, a estrutura, a teoria cognitiva e ossistemas simbólicos.</br>

                                    E) Não é possível encontrarmos características semelhantes em nenhuma cultura humana.</br>

                                    </br>

                                    </p>

                                    <p><strong>Questão 6:</strong> Sobre os mitos, como elaborações culturais, pode-se afirmar que:</br>
                                    </br>

                                    A) são falsos, por isso não podem ser checados cientificamente.</br>

                                    B) são falsos, pois só têm a função de entretenimento.</br>

                                    C) podem ser verdadeiros, mas não podem ser entendidos pela ciência.</br>

                                    D) são importantes no processo de endoculturação e responsáveis por alguns valores que os seres humanos possuem dentro de si, fundamentais à doação de significados dos fenômenos, em geral.</br>

                                    E) são superstições sem valor acadêmico.</br>
                                    
                                    </br>

                                    </p>

                                    <p><strong>Questão 7:</strong> É um processo que acompanha os indivíduos ao longo de suas vidas, lhes permitindo um aprendizado dos comportamentos adequados para viver em sociedade. Pode ser compreendido como um processo de “modelagem”, que tem início na família e que nos torna membros de uma sociedade.</br>
                                    </br>

                                    As frases acima se referem ao conceito de:</br>
                                    </br>

                                    A) Evolução cultural.</br>

                                    B) Diversidade cultural.</br>

                                    C) Socialização.</br>

                                    D) Globalização cultural.</br>
                                    ...
                                    <p><strong>Questão 8:</strong> Sobre a teoria da evolução humana, sabemos atualmente que:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 9:</strong> Analise as frases a seguir sobre efeitos da cultura, e assinale a alternativa correta. </br>
                                    </br>
                                    ...
                                    <p><strong>Questão 10:</strong> A espécie humana apresenta diferenças anatômicas e fisiológicas, porém essas diferenças biológicas não determinam o comportamento das pessoas. Usando como exemplo o caso das mulheres, podemos afirmar que:</br>
                                    </br>
