                        ...
                        <div class="hpanel email-compose mailbox-view">
                            ...
                            <div class="border-top border-left border-right bg-light">
                                <div class="p-m custom-address-mailbox">
                                    ...
                                    <div>
                                       <strong><span class="font-extra-bold">Código da Prova: </span> 19603389930</strong>
                                    </div>
                                    <div>
                                        <strong><span class="font-extra-bold">Curso: </span> CIENCIAS BIOLOGICAS</strong>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <strong><span class="font-extra-bold">II -Questões discursivas –valendo  5,00 pontos Gerada em: 02/04/2019 10:55:42</span></strong>
                                    </div>
                            ...
                            <div class="panel-body panel-csm">
                                <div>
                                    ...
                                    <p><strong>Questão 1:</strong> Os processos de desinfecção visam à eliminação de células vegetativas presentes nos utensílios médico-hospitalares. Antes de executar um processo de desinfecção é fundamental fazer uma limpeza para a remoção de sujidades físicas e químicas. A instrução sobre não se enxaguar após qualquer processo dedesinfecção deve constar:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 2:</strong> Processo utilizado para destruir todas as formas de vida microbiana, por meio do uso de agentes físicos e químicos. A que se refere o enunciado?</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 3:</strong> Segundo a CTBio-Fiocruz (2003), biossegurança pode ser definido como“um conjunto de ações voltadas para a prevenção, minimização ou eliminação de riscos inerentes às atividades que são capazes de comprometer a saúde do homem, dos animais, das plantas, do ambiente ou a qualidade dos trabalhos desenvolvidos”.</br>
                                    </br>

                                    As alternativas a seguir estão relacionadas com esse conceito, EXCETO:</br>
                                    </br>

                                    A) Refere-se à aplicação do conhecimento, técnicas e equipamentos com a finalidade de prevenir a exposição do trabalhador, laboratório e ambiente a agentes potencialmente infecciosos ou biorriscos. </br>

                                    B) É uma temática que deve ser debatida pela sociedade como um todo, não só em relação à sua natureza prática, mas também à ética, por causa da importância da engenharia genética, dos riscos ambientais, do controle social e jurídico, levando em consideração as possibilidades tecnológicas atuais e as consequências futuras. </br>

                                    C) O conceito de biossegurança está cada vez mais valorizado, tendo em vista o entendimento da responsabilidade profissional, que não se limita às ações de prevenção de riscos derivados de sua atividade específica, mas também do ambiente laboratorial e da comunidade, que devem ser preservados e protegidos.</br>

                                    D) Pode ainda ser o conjunto de medidas que visa o controle de infecção, contaminação e tem como princípios básicos a prevenção de doenças, minimizando a "infecção cruzada" e a proteção biológica da equipe e do paciente.</br>

                                    E) Com a publicação da NR32, antes de 2005, já existia uma preocupação inerente com as questões de acidentes de trabalhos relacionados à proteção e segurança à saúde dos trabalhadores.</br>

                                    </p>

                                    <p><strong>Questão 4:</strong> Identifique a correlação dos componentes que formam o triângulo do fogo:</br>
                                    </br>

                                    A) Comburente -madeira.</br>

                                    B) Combustível -oxigênio.</br>

                                    C) Comburente -butano.</br>

                                    D) Calor -álcool.</br>

                                    E) Combustível -papel.</br>
                                    
                                    </br>

                                    </p>

                                    <p><strong>Questão 5:</strong> Os EPIs (equipamentos de proteção individuais) e EPCs (equipamentos de proteção coletivas) podem ser considerados como barreiras de contenção que visam proteger o trabalhador e o ambiente laboratorial, atendendo às boas práticas em laboratórios. Se houver contaminação e os trabalhadores expostos aos patógenos entrarem em contato com terceiros, também haverá risco para tais indivíduos. Assinale a alternativa que corresponde à classificação a que esses equipamentos pertencem e também, quando do contato, a classificação desse contágio.</br>
                                    </br>

                                    A) Primária e primário.</br>

                                    B) Primária e secundário.</br>

                                    C) Secundária e primário.</br>

                                    D) Secundária e terciário.</br>

                                    E) Secundária e secundário.</br>

                                    </br>

                                    </p>

                                    <p><strong>Questão 6:</strong> Qualquer ambiente de trabalho oferece riscos ao trabalhador. Dada à diversidade deambientes possíveis dentro de uma empresa, é impossível especificar um equipamento de proteção individual (EPI)   que cubra todas as exigências, sendo necessário que sejam especificados EPIs por atividade profissional. A descrição detalhada sobre os cuidados com o manuseio e o uso de EPIs devem estar escritos em qual documento?</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 8:</strong> Segundo a Declaração dos Direitos Humanos, todo homem tem direito à vida e precisamos nos preocupar em preservá-la. Uma forma de preservá-la é preocupar-se com a sua segurança no ambiente detrabalho e, se você trabalha em um laboratório, precisa conhecer os riscos a que está exposto e como melhorarsuas condições de segurança. Para isso, existe a necessidade de cuidados que dizem respeito à segurança pessoal (pertinente ao trabalhador) e cuidados que dizem respeito à segurança referente ao laboratório. Sendo assim, assinale a alternativa que corresponde, respectivamente, a cada um deles.</br>
                                    </br>

                                    A) Não se preocupar em dirigir a abertura de tubos de ensaio ou frascos contra si próprio e as outras pessoas; usar pinças e materiais de tamanhos variados sem perfeito estado de conservação.</br>

                                    B) Não colocar alimentos nas bancadas, armários e geladeiras dos laboratórios; rotular imediatamente qualquer reagente ou solução preparada e as amostras coletadas com nome do reagente, nome da pessoa que preparou e a data.</br>

                                    C) Antes de executar uma reação desconhecida não há necessidade de fazer um teste na capela; os acidentes não precisam ser notificados para instâncias superiores.</br>

                                    D) Não existe restrição quanto a alimentos consumidos em ambiente laboratorial; não fornecer informação aos outros colegas de trabalho sobre as experiências executadas.</br>

                                    E) Limpar imediatamente qualquer derramamento de reagentes (no caso de ácidos e bases fortes,o produto deve ser neutralizado antes de proceder a sua limpeza). Em caso de dúvida sobre a toxidez ou derramado, consultar seu superior antes de efetuar a remoção; nunca abrir frascos reagentes antes de ler o rótulo e não testar substâncias químicas pelo odor ou sabor.</br>
                                    ...
                                    <p><strong>Questão 1:</strong> Sobre o processo de esterilização por autoclavagem, observe o trecho a seguir: </br>
                                    </br>

                                    “O processo de autoclavação ou autoclavagem é, em geral, realizado a 121°C por 20 minutos. O aparelho utilizado pode ser considerado um EPI (equipamento de proteção individual) e através dele nota-se que poucos microrganismos são eliminados por esse processo, o que acaba inviabilizando o método”.</br>
                                    </br>

                                    Essa afirmação está correta? Justifique sua resposta.</br>

                                    </br>

                                    </p>

                                    <p><strong>Questão 2:</strong> Barreiras de proteção são importantes dispositivos e funcionam como anteparos paraminimizar acidentes de trabalho e contaminação em laboratórios e indústrias. Cite duas formas de barreiras/contenção que possuem essa finalidade nos laboratórios. Justifique sua resposta.</br>
