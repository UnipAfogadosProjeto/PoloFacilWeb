                        ...
                        <div class="hpanel email-compose mailbox-view">
                            ...
                            <div class="border-top border-left border-right bg-light">
                                <div class="p-m custom-address-mailbox">
                                    ...
                                    <div>
                                       <strong><span class="font-extra-bold">Código da Prova: </span> 19658815341</strong>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <strong><span class="font-extra-bold">II -Questões discursivas –valendo  5,00 pontos Gerada em: 02/04/2019 12:08:46</span></strong>
                                    </div>
                            ...
                            <div class="panel-body panel-csm">
                                <div>
                                    ...
                                    <p>Disciplina: 536260 - ADMINISTRAÇÃO DO RELACIONAMENTO COM O CLIENTE </p>

                                    <p><strong>Questão 1:</strong> Sobre o entendimento e aplicação do termo cliente, identifique e assinale a alternativa INCORRETA.</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 2:</strong> O papel do ombudsmané:</br>
                                    </br>

                                    A) Representar o cliente junto à empresa.</br>

                                    B) Representar a empresa junto ao cliente.</br>

                                    C) Atender aos pedidos dos clientes rapidamente.</br>

                                    D) Prestar serviço de contato com o cliente.</br>

                                    E) Atender as demandas da organização rapidamente.</br>
                                    
                                    </br>
                                    </p>

                                    <p><strong>Questão 3:</strong> Partindo dos estudos do que vem a ser cliente e seus papéis, identifique e assinale a alternativa INCORRETA.</br>
                                    </br>

                                    A) O cliente na condição de consumidor é reconhecido porque compra o produto para que outros utilizam ou consumam.</br>

                                    B) O cliente pode ser uma pessoa física ou jurídica.</br>

                                    C) O cliente é quem adquire (comprador) e/ou que utiliza o produto (usuário / consumidor).</br>

                                    D) O cliente na condição de consumidor é reconhecido porque compra o produto para sua própria utilização ou consumo.</br>

                                    E) Deve-se considerar o cliente o destinatário dos produtos da organização.</br>

                                    </p>

                                    <p><strong>Questão 4:</strong> Algumas empresas formulam produtos específicos para mercados étnicos. Tanto a Revlonquanto a Max Factortêm uma linha de produtos de beleza específicos para a população afrodescendente. A base química é diferente para esses cosméticos, refletindo necessidades genéticas, físicas e próprias dessa população. Essa estratégia de diferenciação também foi expandida para as populações hispânica e asiática. Naturalmente, as populações agradecem pelos produtos adequados a seu perfil. Neste caso, qual é o tipo de diferenciação utilizado pelas duas empresas citadas.</br>
                                    </br>

                                    A) Diferenciação genérica.</br>

                                    B) Diferenciação segmentada.</br>

                                    C) Diferenciação geográfica.</br>

                                    D) Diferenciação climática.</br>

                                    E) Diferenciação focalizada.</br>

                                    </br>

                                    </p>

                                    <p><strong>Questão 5:</strong> Estudando o setor automotivo é possível constatar facilmente os diferentes tipos de soluções que ele oferece para seus clientes, oferecendo, por exemplo, muitas variações dos carros que já estão inicialmente separados por categorias como: utilitários, monovolumes, carros compactos, station wagon, sedans...Há ainda diferentes categorias de preços dos produtos relacionados à marca, ao acabamento e à tecnologia empregada, dentre outros; e, há também, o estilo e o perfil do comprador, pois, mesmo quando o poder aquisitivo não está em questão, há um mesmo carro para um público mais jovem e, o mesmo carro,em outra configuração, para um público mais exigente quanto ao requinte e ao conforto. O caso apresentado refere-se a:</br>
                                    </br>

                                    A) Diferenciação segmentada.</br>

                                    B) Diferenciação automobilística.</br>

                                    C) Diferenciação geral.</br>

                                    D) Diferenciação de preço.</br>

                                    E) Diferenciação genérica.</br>

                                    </br>

                                    </p>

                                    <p><strong>Questão 6:</strong> Para melhor compreender a gestão do relacionamento com os clientes é necessário compreender que as organizações desenvolvem, propositalmente, alternativas para se relacionar com eles, alternativas estas que vão da concepção do produto, seu desenvolvimento, até a comunicação efetiva com os clientes individualmente ou em grupo. Para um relacionamento efetivo é necessário um conjunto de recursos e atividades inter-relacionadas que transformam insumos (entradas) em produtos (saídas), sendo que essa transformação deve agregar valor na percepção dos clientes do processo e exige um conjunto de recursos. A afirmação revela a preocupação que as organizações devem ter com as(os):</br>
                                    </br>
                                    ...
                                    E) A afirmação está equivocada, pois, </br>
                                    
                                    </br>

                                    <p>

                                    <p><strong>Questão 8:</strong> Fazer ofertas de forma diferente implica criar e implementar o composto de marketing(produto, preço, praça e promoção). Para se diferenciar de seus concorrentes, os profissionais de marketingutilizam três tipos de diferenciação, quais são elas?</br>
                                    </br>

                                    A) A diferenciação segmentação, a por benefício e a demográfica.</br>

                                    B) A diferenciação genérica, a estruturada e a clientelada.</br>
                                    
                                    C) A diferenciação focalizada, a segmentada e a prospectada.</br>

                                    D) A diferenciação segmentada, a genérica e a multiuso.</br>

                                    E) A diferenciação genérica, a focalizada e a segmentada.</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 1:</strong> Um dos assuntos apresentados nas aulas foi o de valores e requisitos dos clientes. Agora leia a afirmativa a seguir:</br>
                                    </br>

                                    VALORES E REQUISITOS NÃO MUDAM COM O TEMPO, MAS SÃO VARIÁVEIS ENTRE CLIENTES.</br>
                                    </br>

                                    Esta afirmativa é verdadeira ou falsa? Justifique e explique detalhadamente.</br>

                                    </br>

                                    </p>

                                    <p><strong>Questão 2:</strong> Um dos assuntos apresentados nas aulas foi o de papéis assumidos por clientes. Agora leia a afirmativa a seguir:</br>
                                    </br>

                                    EU VOU AO SUPERMERCADO COMPRAR CHOCOLATE PARA O MEU FILHO E PAGO COM O CARTÃO DE CRÉDITO DA MINHA ESPOSA. OS PAPÉIS SÃO: EU SOU O PAGANTE, MEU FILHO É O COMPRADOR E MINHA ESPOSA É A COMPRADORA.</br>
                                    </br>
