                        ...
                        <div class="hpanel email-compose mailbox-view">
                            ...
                            <div class="border-top border-left border-right bg-light">
                                <div class="p-m custom-address-mailbox">
                                    ...
                                    <div>
                                       <strong><span class="font-extra-bold">Código da Prova: </span> 18484121135</strong>
                                    </div>
                                    <div>
                                        <strong><span class="font-extra-bold">Curso: </span> Sup Tec em Gestão Ambiental</strong>
                                    </div>
                                    <div>
                                        <strong><span class="font-extra-bold">Série ou Período: </span>  2º Bimestre - 1º Semestre
</strong>
                                    </div>
                                     <div>
                                        <strong><span class="font-extra-bold">I -Questões objetivas –valendo  10,00 pontos Gerada em: 04/06/2018 15:15:56</span></strong>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body panel-csm">
                                <div>
                                    ...
                                    <p><strong>Questão 1:</strong> O processo de compras pode ser dividido em duas grandes áreas: aquisição, que compreende as atividades de seleção de fornecedores e compras; e a administração de materiais, que define quais, quantos e quando os materiais devem ser comprados, controlando o estoque, de maneira que receba suprimento adequadamente. Na aquisição, para um processo seguro, é importante seguir alguns passos que atendam a alguns requisitos. Analise as afirmativas a seguir:</br>
                                    </br>

                                    I -Os contratos podem ser de curto ou longo prazo, o que implica que a empresa não atue com um fornecedor apenas, nem com uma dezena deles. Ter dois ou três fornecedores está dentro do aceitável.</br>

                                    II -A customização oferece itens feitos exclusivamente para determinada empresa. O produto ou serviço pode ser comum, mas preparado para cada necessidade.</br>

                                    III -A quantidade de fornecedores para trabalhar em cada produto ou categoria de produtos, depende da política da empresa em relação às compras.</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 3:</strong> Um item tem custo de armazenagem anual total de R$ 0,80 por unidade e preço de compra unitário de R$3,00. Considere uma taxa de juros de 15% ao ano. A demanda anual é de 12.000 unidades,com lotes de compra de Q=1.000 unidades. Qual o estoque médio desse item?</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 4:</strong> Na decisão entre comprar ou fabricar, a empresa deve considerar, entre outras coisas:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 5:</strong> A empresa JCC Ltda. fez uma revolução nas atividades de compras, selecionou um comprador para os itens de estoque de classificação A, outro comprador para os itens de classificação B, outropara os itens de classificação C e ainda um quarto comprador para comprar materiais de escritório, materiaisde limpeza, itens de manutenção etc. Esses itens citados por último são classificados como:</br>
                                    </br>

                                    A) Estoques de matéria prima.</br>

                                    B) Materiais auxiliares.</br>

                                    C) Produtos acabados.</br>

                                    D) Estoques em trânsito.</br>

                                    E) Estoques em consignação.</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 6:</strong> Uma empresa que atue com um modelo de produção puxado, ou seja, vende primeiro e produz depois, quando produz o item vai direto para o cliente. Assim a necessidade de produção é conhecida,possibilitando programar entregas com fornecedores próximos dos horários de utilização na produção. Em um cenário desse, é possível:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 7:</strong> O layouté uma preocupação presente desde a escolha do local do estoque atéa do tipo de estrutura, se será climatizado ou não etc. Uma vez definido o layout, este deve garantir:</br>
                                    </br>

                                    I -Que se tire o máximo proveito do espaço.</br>

                                    II -Que simplifique ao máximo cada etapa da operação.</br>

                                    III -Que os itens de menor giro fiquem em locais de acesso mais fáceis.</br>
                                    </br>

                                    Assim podemos dizer que:</br>
                                    </br>

                                    A) Somente as afirmativas I e III estão corretas.</br>
                                    ...
                                    E) Somente a afirmativa II está errada.</br>
                                    </br>

                                    </p>


                                    <p><strong>Questão 8:</strong> A empresa JCC Ltda. decidiu controlar melhor os recursos patrimoniais, acompanhando, por exemplo, o tempo de vida útil, programando manutenção periódica, avaliando a produtividade. Dos itens a seguir, qual é um recurso patrimonial?</br>
                                    </br>
                                    ...
                                    </br><img src="./img/464860_recursos_materiais_e_patrimoniais_img1.JPEG"></br>

                                    </br>Nesse cenário, o giro de estoque é:</br>

                                    </br><img src="./img/464860_recursos_materiais_e_patrimoniais_img2.JPEG"></br>
                                    </br>
