                        ...
                        <div class="hpanel email-compose mailbox-view">
                            ...
                            <div class="border-top border-left border-right bg-light">
                                <div class="p-m custom-address-mailbox">
                                    ...
                                    <div>
                                       <strong><span class="font-extra-bold">Código da Prova: </span> 18154682542</strong>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                     ...
                                     <div>
                                        <strong><span class="font-extra-bold">I -Questões objetivas –valendo  10,00 pontos Gerada em: 14/06/2018 16:45:04 </span></strong>      
                                </div>
                            </div>
                            <div class="panel-body panel-csm">
                                <div>
                                    ...
                                    <p><strong>Questão 1:</strong> Não é espécie de direito constitucional:</br>
                                    </br>

                                    A) Direito constitucional positivo.</br>

                                    B) Direito constitucional penal.</br>

                                    C) Direito constitucional comparado.</br>

                                    D) Direito constitucional geral.</br>

                                    E) Direito Constitucional parcial.</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 2:</strong>  Sobre os direitos individuais é correto afirmar que:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 3:</strong> Sobre o poder constituinte derivado pode-se afirmar que:A) Trata</br>
                                    </br>

                                    A) Trata-se do poder de criar uma constituição e tem como características ser inicial, incondicionado e ilimitado.</br>

                                    B) Trata-se do poder de alterar uma Constituição e tem como características ser limitado e condicionado.</br>

                                    C) Trata-se do poder de derivar leis a partir de uma Constituição já revogada.</br>

                                    D) É um poder ilimitado, uma vez que a Constituição deve estar sempre atualizada.</br>

                                    E) É um poder incondicionado.</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 4:</strong> Quanto ao uso do habeas data, pode-se afirmar que:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 5:</strong> A respeito da proibição de tortura, pode-se afirmar que:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 6:</strong> É correto afirmar, em relação à manifestação do pensamento, que: </br>
                                    </br>
                                    ...
                                    <p><strong>Questão 7:</strong> A qual direito-garantia individual consagrado na Constituição Federal de 1988 refere-sea seguinte frase: “A lei não prejudicará o direito adquirido, o ato jurídico perfeito e a coisa julgada”?</br>
                                    </br>

                                    A) Liberdade de profissão.</br>

                                    B) Direito ao devido processo legal.</br>

                                    C) Direito de resposta.</br>

                                    D) Limitação da retroatividade da lei.</br>

                                    E) Direito de voto.</br>
                                    </br>

                                    </p>


                                    <p><strong>Questão 8:</strong> É o poder exercido no Estado e pelo Estado:</br>
                                    </br>

                                    A) Poder constitucional.</br>

                                    B) Poder constituinte.</br>

                                    C) Poder político.</br>

                                    D) Poder executivo.</br>

                                    E)  Poder político e constituinte.</br>
                                    </br>

                                    </p>


                                    <p><strong>Questão 9:</strong>  Quanto ao uso do habeas corpus, pode-se afirmar que:</br>
                                    </br>
