                        ...
                        <div class="hpanel email-compose mailbox-view">
                            ...
                            <div class="border-top border-left border-right bg-light">
                                <div class="p-m custom-address-mailbox">
                                    ...
                                    <div>
                                       <strong><span class="font-extra-bold">Código da Prova: </span> 18151877476</strong>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                     ...
                                     <div>
                                        <strong><span class="font-extra-bold">I - Questões objetivas – valendo 10,00 pontos Gerada em: 04/06/2018 15:22:52</span></strong>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body panel-csm">
                                <div>
                                    ...
                                    <p><strong>Questão 2:</strong> Uma empresa que atue com um sistema de produção em que produz de acordo com a previsão de demanda do mercado deve seguir:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 4:</strong> Para alguns autores, a decisão entre produzir ou terceirizar deve levar em consideração:</br>
                                    </br>
                                    ...
                                    III -Nível de estoque: será função da confiabilidade do atendimento. IV -Área necessária: tanto para produção interna quanto para estocagem da quantidade enviada pelofornecedor.</br>
                                    </br> 
                                    ...
                                    <p><strong>Questão 5:</strong> Na decisão entre comprar ou fabricar, a empresa deve considerar, entre outras coisas:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 6:</strong> Ter estoque possibilita algumas vantagens, entre elas podemos citar:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 9:</strong> A empresa A tem demanda de 40.000 unidades de determinado item e compra lotes maiores para fazer menos pedidos no ano. A empresa B tem a mesma demanda, só que compra lotes menores e faz mais pedidos no ano.</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 10:</strong> Alguns produtos praticamente só têm procura em determinadas épocas, como, por exemplo, os livros didáticos, os ovos de páscoa, as árvores de Natal. Esses produtos são o que chamamos de produtos com demanda:</br>
                                    </br>
