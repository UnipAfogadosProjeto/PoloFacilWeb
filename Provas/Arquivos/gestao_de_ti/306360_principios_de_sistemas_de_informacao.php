                        ...
                        <div class="hpanel email-compose mailbox-view">
                            ...
                            <div class="border-top border-left border-right bg-light">
                                <div class="p-m custom-address-mailbox">
                                    ...
                                    <div>
                                       <strong><span class="font-extra-bold">Código da Prova: </span> 18893764947</strong>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                     ...
                                     <div>
                                        <strong><span class="font-extra-bold">I -Questões objetivas –valendo  10,00 pontos Gerada em: 04/06/2018 19:06:31</span></strong>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body panel-csm">
                                <div>
                                    ...
                                    <p><strong>Questão 1:</strong> A ideia da ______________ é melhorar a comunicação entre os funcionários e parceiros, interligando fornecedores e clientes de fora da corporação, além de acumular uma base de conhecimento que possa ajudar os funcionários a criar novas soluções. Esse conceito refere-se a:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 2:</strong> As Lesões por Esforços Repetitivos (LER) representam uma síndrome de ________ nos membros superiores, com queixa de grande incapacidade funcional, causada primariamente pelo próprio uso das extremidades superiores em tarefas que envolvem movimentos repetitivos ou posturas forçadas. O termo que preenche a lacuna corretamente é:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 3:</strong> Os softwaresde sistemas estão intimamente ligados à administração e gerência do hardwaree apoiam operações de sistemas e de redes de computadores. Eles também podem ser chamados de:</br>
                                    </br>

                                    A) Sistemas Operacionais.</br>

                                    B) Sistemas Colaborativos.</br>

                                    C) Sistemas Controle de Processos.</br>

                                    D) Sistema de Processamento de Transações.</br>

                                    E) Sistema de Controle de Cartões.</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 4:</strong> Podemos classificar os sistemas de várias formas: com relação a quantidade de elementos, complexidade, capacidade de mudanças, interação com o ambiente ou tempo de vida. Um sistema que interage com o ambiente e adapta-se às mudanças demandadas por ele pode ser classificado como:</br>
                                    </br>

                                    A) Simples e Fechado.</br>

                                    B) Aberto e Adaptativo.</br>

                                    C) Dinâmico e Temporário.</br>

                                    D) Estável e Fechado.</br>

                                    E) Aberto e Permanente.</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 5:</strong> Redes de computadores são o conjunto formado pelos meios de transmissão, dispositivos de rede, Softwaree protocolos de rede que, quando integrados, permitem compartilhar dados, informações e tarefas de processamento. A comunicação nas redes de computadores pode acontecer de duas formas: assíncrona e síncrona. Qual a principal característica da comunicação assíncrona:</br>
                                    </br>

                                    A) Alto custo de implementação.</br>

                                    B) Alta velocidade de transmissão.</br>

                                    C) Transmissão em blocos de caracteres.</br>

                                    D) Não há vínculo com o tempo.</br>

                                    E) Há vínculo com o tempo.</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 6:</strong> Qual tipo a seguir não representa uma memória auxiliar?</br>
                                    </br>

                                    A) ROM.</br>

                                    B) HD (disco rígido).</br>
                                    ...
                                    <p><strong>Questão 8:</strong> Em um computador, o softwareé classificado como a parte lógica, cuja função é fornecer instruções para o hardware. Ele pode ser classificado como:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 9:</strong> Não é uma vantagem de implementação de um ERP:</br>
                                    </br>

                                    A) Otimização do fluxo da informação e a qualidade desta dentro da organização (eficiência na tomada de decisão).</br>

                                    B) Eliminação de redundância de atividades.</br>

                                    C) A adoção de melhores práticas aumenta o grau de imitação e padronização entre as empresas de umsegmento.</br>

                                    D) Redução dos limites de tempo de resposta ao mercado e atendimento ao cliente.</br>

                                    E) Aperfeiçoamento dos processos de trabalho: a competição exige que as companhias estruturem seusprocessos de negócios de modo que estes sejam tão eficazes e orientados ao cliente quanto for possível. </br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 10:</strong> Entre os conceitos de sistemas operacionais, temos:</br>
                                    </br>

                                    I) Conjunto de programas escritos com o intuito de realizar controles diversos, como o do hardwaredo computador. </br>

                                    II) Gerenciamento de recursos de entrada e saída, de armazenagem dos programas e de dados.</br>

                                    III) Controle da interface com os softwaresaplicativos.</br>
                                    </br>

                                    Está(ão) correto(s):</br>
                                    </br>
