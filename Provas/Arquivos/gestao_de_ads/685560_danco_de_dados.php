                        ...
                        <div class="hpanel email-compose mailbox-view">
                            ...
                            <div class="border-top border-left border-right bg-light">
                                <div class="p-m custom-address-mailbox">
                                    ...
                                    <div>
                                       <strong><span class="font-extra-bold">Código da Prova: </span> 18347615789</strong>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                     ...
                                     <div>
                                        <strong><span class="font-extra-bold">I -Questões objetivas –valendo  10,00 pontos Gerada em: 04/06/2018 16:47:21</span></strong>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body panel-csm">
                                <div>
                                    ...
                                    <p>Disciplina: 685560 - Banco de Dados/p>

                                    <p><strong>Questão 1:</strong> O comando correto para se criar a tabela a seguir é:</br>
                                    
                                    </br><img src="./img/685560_banco_de_dados_img1.JPEG"></br>
                                    </br>

                                    A) CREATE DATABASE TABELA_X.</br>

                                    B) USE TABELA_X.</br>

                                    C) DROP TABLE TABELA_X.</br>

                                    D) CREATE TABLE TABELA_X(CAMPO_1 CHAR(1),CAMPO_2 CHAR(2)).</br>

                                    E) TRUNCATE TABLE TABELA_X.</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 2:</strong> Sobre as chaves de um banco de dados, assinale a alternativa incorreta.</br>
                                    </br>

                                    A) Uma chave candidata pode vir a se tornar uma chave primária.</br>

                                    B) Uma chave estrangeira (FK) é uma chave primária (PK) que vem de outra tabela.</br>

                                    C) Uma chave composta é uma chave que possui mais de um atributo.</br>

                                    D) Uma chave estrangeira (FK) pode compor uma chave primária (PK).</br>

                                    E) A chave estrangeira nasce dentro da própria tabela.</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 3:</strong>  Pensando em promoções para seus clientes, o Sr. Manoel resolveu adicionar um novo campona tabela de cliente, a data de nascimento (DT_NASCIMENTO). Para efetuar esse campo, qual comando deve ser acionado?</br>
                                    </br>

                                    A) ALTER TABLE CLIENTE.ADD DT_NASCIMENTO DATE.</br>

                                    B) ALTER TABLE CLIENTEADD CONSTRAINT DT_NASCIMENTO.</br>

                                    C) ALTER TABLE CLIENTEADD DT_NASCIMENTO DATETIME.</br>

                                    D) ALTER TABLE CLIENTEADD DT_NASCIMENTO INT.E) DROP TABLE CLIETE.</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 4:</strong>Ferramentas CASE existem para facilitar a vida dos DBAs e dos analistas de bancos de dados. Dentre suas funcionalidades, assinale a alternativa incorreta.</br>
                                    </br>

                                    A) Provêm documentação do projeto de Banco de Dados.</br>

                                    B) Algumas ferramentas disponibilizam um dicionário de dados (metadados) sem necessidade de o modelo ser gerado no Banco de Dados.</br>

                                    C) Constroem modelos de dados sem interferência do usuário/operador.</br>

                                    D) Constroem bases de dados sem a necessidade de digitar nenhum código SQL.</br>

                                    E) Agilizam o trabalho de construção do modelo de dados pelo analista de sistema.</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 5:</strong>  Considerando que em uma determinada empresa há funcionários que ganham de R$ 1.000,00 aR$ 20.000,00, o comando a seguir retornará?</br>
                                    </br>

                                    SELECT * FROM FUNCIONARIOWHERE SALARIO >= 10.000,00.</br>
                                    </br>

                                    A) Todos os funcionários com salário maior que 10.000,00.</br>

                                    B) Todos os funcionários com salário menor que 10.000,00.</br>

                                    C) Todos os funcionários com salário igual a 10.000,00.</br>

                                    D) Todos os funcionários com salário maior ou igual a 10.000,00.</br>

                                    E) Nenhum funcionário.</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 6:</strong> Analise o comando a seguir: </br>
                                    </br>

                                    SELECT * FROM TABELAWHRER CAMPO_1 = 10 OR CAMPO_2 = 20</br>
                                    </br>

                                    De acordo com o esquema exposto, assinale a alternativa correta.</br>
                                    </br>

                                    A) A consulta só retornará dados se as duas condições forem verdadeiras.</br>

                                    B) A consulta só retornará dados se nenhuma das duas condições forem verdadeiras.</br>

                                    C) A consulta só retornará dados se a primeira das duas condições for verdadeira.</br>

                                    D) A consulta só retornará dados se a segunda das duas condições for verdadeira.</br>

                                    E) A consulta retornará dados se qualquer uma das condições for verdadeira.</br>
                                    </br>
                                    </p>


                                    <p><strong>Questão 7:</strong> Analise as tabelas a seguir:</br>
                                     
                                    </br><img src="./img/685560_banco_de_dados_img2.JPEG"></br>
                                    </br>

                                    Com base no esquema exposto, assinale a alternativa correta.</br>
                                    </br>

                                    A) São derivados de um relacionamento de cardinalidade N -N no MER.</br>

                                    B) São derivados de um relacionamento de cardinalidade 1 -N no MER.</br>

                                    C) São derivados de um relacionamento de cardinalidade 1 -1 no MER.</br>

                                    D) São derivados de um relacionamento de cardinalidade 0 -1 no MER.</br>

                                    E) São derivados de um relacionamento de cardinalidade 0 -N no MER.</br>
                                    </br>

                                    </p>


                                    <p><strong>Questão 8:</strong> Consideremos uma tabela de produto e que um produto duplicado foi inserido nela. Após um levantamento, constatou-se que o produto errado é o de código X. Para removermos esse dado, devemos:</br>
                                    </br>

                                    A) Fazer um SELECT em PRODUTO usando WHERE COD_PRODUTO = X.</br>

                                    B) Fazer um DELETE em PRODUTO usando WHERE COD_PRODUTO = X.</br>

                                    C) Fazer um DELETE em PRODUTO sem WHERE.</br>

                                    D) Fazer um UPDATE em PRODUTO usando WHERE COD_PRODUTO = X.</br>

                                    E) Fazer um INSERT em PRODUTO usando WHERE COD_PRODUTO = X.</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 9:</strong> Em um Modelo Entidade Relacionamento (MER), as entidades, os atributos e as relações são identificados, respectivamente, por:</br>
                                    </br>

                                    A) Retângulo, elipse e losango.</br>

                                    B) Elipse, losango e retângulo.</br>

                                    C) Losango, retângulo e elipse.</br>

                                    D) Retângulo, losango e elipse.</br>

                                    E) Losango, elipse e retângulo.</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 10:</strong> Consideremos que estamos trabalhando com duas tabelas: A e B. Para que minha consulta retorne todos os dados da tabela A, mesmo que não exista correspondência na tabela B, devemos usar:</br>
                                    </br>
                                    ...
                                    C) LEFT JOIN de A para B.</br>

                                    D) LEFT JOIN de B para A.</br>

                                    E) RIGHT JOIN de A para B.</br>
