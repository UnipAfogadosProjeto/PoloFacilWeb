                        ...
                        <div class="hpanel email-compose mailbox-view">
                            ...
                            <div class="border-top border-left border-right bg-light">
                                <div class="p-m custom-address-mailbox">
                                    ...
                                    <div>
                                       <strong><span class="font-extra-bold">Código da Prova: </span> 18884630255</strong>
                                    </div>
                                    <div>
                                        <strong><span class="font-extra-bold">Curso: </span> SUP TEC EM GESTÃO COMERCIAL</strong>
                                    </div>
                                    <div>
                                        <strong><span class="font-extra-bold">Série ou Período: </span> : 2º Bimestre -3º Semestre</strong>
                                    </div>
                                     <div>
                                        <strong><span class="font-extra-bold">I - Questões objetivas – valendo 5,00 pontos Gerada em: 08/06/2018 15:47:51</span></strong>
                                    </div>
                                    <div>
                                        <strong><span class="font-extra-bold">II -Questões discursivas –valendo  5,00 pontos Gerada em: 04/06/2018 16:23:23</span></strong>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body panel-csm">
                                <div>
                                    ...
                                    <p>Disciplina: 712160 - Sistemas de Informação em Comércio e Serviços</p>

                                    <p><strong>Questão 1:</strong>  Os Sistemas de Apoio à Decisões (SAD) é um sistema de informação que combina modelos e dados em uma tentativa de resolver os problemas semiestruturados e alguns problemas não estruturados, com intenso envolvimento do usuário. Exemplo de SADs é o sistema de apoio a decisões logísticas, que leva em consideração as rotas, a capacidade de carga dos veículos disponíveis, os valores de frete, prazos de entrega, dentre uma série de outros fatores. Dependendo da sofisticação do sistema e estando o processo bem delimitado sob o ponto de vista analítico ou matemático, o sistema poderá efetuar automaticamente simulações e interações, buscando as melhores alternativas para um determinado problema. Estes sistemas são utilizados pelas pessoas que se encontram em qual nível organizacional?</br>
                                    </br>

                                    I.Nível Estratégico.</br>

                                    II.Nível Operacional.</br>

                                    III.Nível Tático.</br>

                                    IV.Nível de Conhecimento.</br>
                                    </br>

                                    É correto apenas o que afirma em:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 3:</strong> A gestão na cadeia de suprimentos são processos de negócios que consistem em gerenciar os fluxos de bens, serviços e informações dentro de uma cadeia integrada, que procura eleger matérias primas e transformá-las em produtos intermediários e acabados concatenando clientes, varejo, transporte, indústrias e fornecedores, de forma a articular os serviços ou produtos desde a fonte até o consumidor. O Supply Chain Management (SCM), como é também conhecido, é a integração de todos os processos envolvidos em uma cadeia de suprimentos aliados ao conjunto de técnicas utilizadas nas etapas desta cadeia, incluindo transporte, estoque e custo. Segundo O’Brien e Marakas (2013), como cada processo da cadeia de suprimentos agrega valor aos produtos ou serviços produzidos por uma empresa, essa cadeia muitas vezes é chamada cadeia de valores, um conceito diferente, porém relacionado. Hoje, em qualquer situação, muitas companhias usam a tecnologia da internet para criar sistemas de negócios eletrônicos interempresariais para gestão da cadeia de gestão que ajudam a agilizar os processos tradicionais desta.</br>
                                    </br>

                                    Considerando este conceito, avalie as asserções a seguir e a relação proposta entre elas.</br>
                                    </br>

                                    I.A Cadeia de Suprimentos tem como objetivo auxiliar na redução dos custos ao longo de todo o processo, assim como tem a intenção de atender as exigências dos clientes de forma mais assertiva e com maior qualidade.</br>

                                    PORQUE</br>

                                    II.O foco das empresas hoje é em seu cliente, por isso o SCM busca uma gestão de qualidade, entregando o que o cliente deseja, no preço e nas condições estabelecidas.</br>
                                    </br>

                                    A respeito dessas asserções, assinale a alternativa correta.</br>

                                    A) A asserção I é uma proposição verdadeira e a asserção II é falsa.</br>

                                    B) As asserções I e II são proposições verdadeiras, e a proposição II é uma justificativa correta da proposição I .</br>

                                    C) A asserção II é uma proposição verdadeira e a asserção I é falsa .</br>

                                    D) As asserções I e II são falsas.</br>

                                    E) As asserções I e II são proposições verdadeiras, mas a proposição I não é uma justificativa correta da proposição II.</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 4:</strong>  Segundo O'Brien e Marakas (2013), cada vez mais, os computadores e a internet estãoproporcionando a base para a automaçãoda equipe de vendas. Em muitas companhias, a equipe de vendas está sendo equipada com notebooks, navegadores web e software para controle dos contatos de vendas que permitem a conexão com sites de marketing na internet, extranet e intranet da companhia. Estes autores destacam que essa tendência não apenas melhora a produtividade individual dos vendedores, mas também agiliza consideravelmente a obtenção e a análise dos dados de vendas do campo para os gerentes de vendas localizados nas sedes da empresa. Emcontrapartida, a gerência de marketing e vendas consegue melhorar a oferta de informações e o apoio dado ao seu pessoal de vendas. Portanto, muitas companhias estão vendo a automação da equipe de vendas como forma de obter vantagem estratégica em produtividade de vendas e agilidade nas ações de marketing. O conhecimento das tendências mercadológicas atuais, do comportamento dos consumidores, das estratégias dos concorrentes, do posicionamento no mercado, faz parte de cada um dos módulos de um sistema de informação de vendas e marketing. Sobre estes módulos, relacione a coluna 1 com a coluna 2 e assinale a alternativa corretacom o conceito e sua respectiva definição.</br>
                        
                                    </br><img src="./img/712160_sistemas_de_informacao_em_comercio_e_servisos_img1.JPEG"></br>
                                    </br>

                                    São corretas as relações que constam na alternativa:</br>
                                    </br>

                                    A) (I) corresponde a (1), (II) corresponde a (2), (III) corresponde a (3) e (IV) correspondea (4).</br>

                                    B) (I) corresponde a (2), (II) corresponde a (3), (III) corresponde a (4) e (IV) correspondea (1).</br>

                                    C) (I) corresponde a (4), (II) corresponde a (3), (III) corresponde a (2) e (IV) corresponde a (1).</br>

                                    D) (I) corresponde a (4), (II) corresponde a (1), (III) corresponde a (3) e (IV) corresponde a (4).</br>

                                    E) (I) corresponde a (4), (II) corresponde a (2), (III) corresponde a (1) e (IV) corresponde a (3).</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 5:</strong> Desde que a informática tomou conta de nossas vidas, imensos volumes de informação têm sido sistematicamente coletados e armazenados. A simples armazenagem e recuperação dessa informação já traz um grande benefício, pois agora já não é mais necessário procurar informação em volumosos e ineficazes arquivos de papel. Contudo, apenas recuperar informação não propicia todas as vantagens possíveis. Data Mining éuma das novidades da Ciência da Computação que veio para ficar. Com a geração de um volume cada vez maior deinformação, é essencial tentar aproveitar o máximo possível desse investimento. Um banco de dados detransações comerciais pode, por exemplo, conter diversos registros indicando produtos que são comprados em conjunto. Quando se descobre isso pode-se estabelecer estratégias para otimizar os resultados financeiros da empresa. </br>
                                    </br>

                                    Quanto ao objetivo de Data Mining podemos citar:</br>
                                    </br>

                                    I.Como sendo o processo de explorar grandes quantidades de dados à procura de padrões consistentes, como regras de associação ou sequências temporais, para detectar relacionamentos sistemáticos entre variáveis, gerando assim novos subconjuntos de dados.</br>

                                    II.Como sendo o processo de análise de dados de diferentes perspectivas e resumindo-o em informações úteis.</br>

                                    III.Como sendo o processo de integração de dados de uma ou mais fontes que envolve os processos de extração, transformação e carregamento dos dados que serão padronizados e armazenados.</br>

                                    IV.Como sendo o processo de coletar dados internos sejam eles provenientes dos sistemas existentes na empresa, tabelas, documentos, gráficos, textos, sons, imagens, vídeos, entre tantos outros formatos e, dados externos, como índices econômicos, políticos, financeiros, estatísticas de redes sociais, de tendências e de previsões, enfim, dados que tenham características relevantes ao assunto que será gerido não importando o formato, sempre será possível captar o dado e armazená-lo.</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 6:</strong> Para compreendermos a Gestão do Conhecimento devemos defini-la: Gestão do conhecimento é o conjunto de esforços ordenados e sistematizados visando a criar novo conhecimento, difundi-lo na organização para os que dele precisam e incorporá-lo a produtos, serviços e sistemas, bem como a protegê-lo contra uso indevido. O primeiro ponto da estratégia de gestão do conhecimento é definir os critérios para escolher que tipode conhecimento a empresa planeja obter, e a forma de consegui-lo e distribuí-lo.O’Brien e Marakas(2012), enfatiza que as empresas criadoras de conhecimento exploram dois tipos de conhecimento. Um é o conhecimento explícito: dados, documentos e coisas escritas ou armazenadas no computador. O outro tipo é o conhecimento tácito: os “como fazer” do conhecimento, que estão nos empregados. Lacombe (2011), coloca que o conhecimento explícito pode ser expresso sob a forma de números e palavras. O conhecimento tácito é algo dificilmente visível e exprimível.</br>
                                    </br>

                                    Considerando este cenário, avalie as asserções a seguir e a relação proposta entre elas.</br>
                                    </br>

                                    I.O conhecimento tácito é muito pessoal e difícil de formalizar, o que dificulta sua transmissão e compartilhamento.</br>

                                    PORQUE</br>

                                    II.O conhecimento tácito está enraizado nas ações e experiências de uma pessoa, bem como em suas emoções, valores e ideias.</br>
                                    </br>

                                    A respeito dessas asserções, assinale a alternativa correta.</br>
                                    </br>

                                    A) As asserções I e II são proposições verdadeiras, e a proposição II é uma justificativa correta da proposição I.</br>

                                    B) A asserção I é uma proposição verdadeira e a asserção II é falsa.</br>
                                    ...
                                    B) A asserção II é uma proposição verdadeira e a asserção I é falsa.</br>

                                    C) As asserções I e II são proposições verdadeiras, e a proposição II é uma justificativa correta da proposição I.</br>
                                    ...
                                    <p><strong>Questão 8:</strong> Conforme Audy (2011) et al, no campo dos sistemas de informação, uma transação é uma troca de informações que ocorre quando duas partes estão envolvidas em alguma atividade. As operações rotineiras que ocorrem em um ambiente organizacional envolvem transações de diversos tipos: o fechamento de um pedido com um cliente, a matricula de um aluno em uma universidade, a emissão de uma receita por um médico ou abaixa de uma quantidade do estoque de uma matéria-prima. As transações constituem os eventos básicos da vida de uma organização. Os Sistemas de Processamento de Transações atendem às equipes operacionais, sendo as tarefas, os procedimentos e as metas predefinidos e muito estruturados. Citamos como exemplos, pedidos de vendas, expedição de produtos, reservas de passagens e hotéis, folha de pagamento, registro de funcionários,matrícula de um aluno, registro de saída de um produto no estoque. Segundo Audy (2011) et al, os sistemas de processamento de transações (SPT) são os sistemas de informação que executam e registram as transações rotineiras que a organização realiza como parte de seus processos de negócio.</br>
                                    </br>

                                    Considerando este conceito, avalie as asserções a seguir e a relação proposta entre elas.</br>
                                    </br>

                                    I.Essas rotinas são realizadas pelo nível operacional da organização, razão pela qual esses sistemas também são denominados sistemas operativos ou transacionais. Os componentes de um SPT contemplam pessoas, procedimentos, software, banco de dados e hardware que tem a finalidade de registrar as transações empresariais realizadas durante o funcionamento da organização.</br>

                                    PORQUE</br>

                                    II.Essas transações são rotineiras e repetitivas, mas de grande valia para a empresa, pois que representam a entrada dos dados iniciais para todos os outros sistemas, sejam integrados pela abordagem tradicional ou metodológica. São nesses sistemas que a qualidade do dado é verificada.</br>
                                    </br>
