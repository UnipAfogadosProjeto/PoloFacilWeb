                        ...
                        <div class="hpanel email-compose mailbox-view">
                            ...
                            <div class="border-top border-left border-right bg-light">
                                <div class="p-m custom-address-mailbox">
                                    ...
                                    <div>
                                       <strong><span class="font-extra-bold">Código da Prova: </span> 18335556937</strong>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                     ...
                                     <div>
                                        <strong><span class="font-extra-bold">I - Questões objetivas – valendo 10,00 pontos </span></strong>
                                    </div>
                                    <div>
                                        <strong><span class="font-extra-bold">II - Questões discursivas –valendo  5,00 pontos Gerada em: 04/06/2018 14:44:55</span></strong>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body panel-csm">
                                <div>
                                    ...
                                    <p>Disciplina: 660580 - Fundamentos de Geografia: Organização do Espaço e Conceitos</p>

                                    <p><strong>Questão 1:</strong> A descoberta dos povos indígenas das Américas fez com que a cultura europeia se inteirasse de lugares e de pessoas diferentes, o outro, com outros hábitos, costumes, tradições, curiosidades, quepassaram a ser guardadas, dando origem ao que se denominou:</br>
                                    </br>

                                    A) Sítios arqueológicos.</br>

                                    B) “Gabinetes de curiosidades”.</br>

                                    C) Salas de inventários.</br>
                                    ...
                                    <p><strong>Questão 2:</strong> Leia atentamente o texto a seguir:</br>
                                    </br>

                                    “Por essas razões, não se pode pensar nos conceitos como algo pronto e acabado, que servem como memorização, como tradicionalmente ocorria (e ocorre) no ensino da Geografia. A exemplo de outras ciências, a seleção dos conceitos pode ser marcada por recortes culturais, sociais e históricos, tendo por base as discussões acadêmicas, os resultados das investigações, as contribuições dos discursos políticos e sociais, os meios de comunicação e as práticas sociais. Os conceitos básicos aqui apresentados como estruturantes da Geografia devem ser considerados sempre, permeados pelas dinâmicas da sociedade, porque qualquer que seja a opção teórico-metodológica adotada pelo professor, deve-se levar o aluno a ter uma visão da complexidade social do mundo.” (PCNs -Ensino Médio)</br>
                                    </br>

                                    Podemos considerar como conceitos básicos, estruturantes da Geografia, exceto:</br>
                                    </br>

                                    A) Espaço e tempo.</br>

                                    B) Lugar.C) Paisagem.</br>

                                    D) Região.</br>

                                    E) Estrutura geológica.</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 3:</strong> Nas décadas de 1960 e 1970, uma corrente da Geografia rompeu com a Geografia Moderna Tradicional, apresentando-se como “Nova Geografia”, contrária às aulas de campo. Julgando-as desnecessárias, substituiu o campo por pesquisas em laboratório, com uso de medições matemáticas, gráficos e tabelas. Trata-se da Geografia:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 4:</strong> Para Ratzel, os povos são capazes de se adaptarem ao meio natural, e, os que atingem essa adaptação de maneira satisfatória, são os mais aptos a sobreviver. Dentro dessa concepção, os _________ seriam superiores.Complete a lacuna:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 5:</strong>  Segundo a análise de Manuel Castells, o urbano seria uma unidade espacial da reproduçãoda força de trabalho, sob uma ótica ___________, estabelecendo a estrutura econômica como principal eloconceitual de uma teoria do espaço urbano. A mencionada ótica corresponde ao pensamento:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 6:</strong> Quem fez a seguinte afirmação acerca da Geografia:</br>
                                    </br>

                                    “A Geografia tem como missão investigar como as leis físicas e biológicas que regem o globo se combinam e se modificam ao aplicarem-se às diversas partes da superfície terrestre. A Terra é o domínio do Homem”.</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 7:</strong> Outra dicotomia trabalhada pela Geografia refere-se aos pares local e global. Há uma complexidade, pois o global ou local dependem do contexto onde estão inseridos, da paisagem, do território; dependem, também, do recorte que o professor vai dar à problemática que vai ser ensinada. Como afirmou Pascal, é impossível conhecer as partes sem conhecer o todo e vice-versa.Assim, em nossos estudos, utilizamos alguns exemplos de problemas inseridos no modo de produção capitalista, que extrapolam um lugar e podem ser encontrados em vários lugares do mundo. Um dos maisgritantes é a apropriação do trabalho de outrem, como:</br>
                                    </br>
                                    ...
                                    C) O respeito aos direitos humanos.</br>

                                    D) A igualdade trabalhista.</br>

                                    E) A diversidade cultural.</br>
                                    </br>

                                    </p>


                                    <p><strong>Questão 8:</strong> Um importante autor da corrente geográfica crítica ou radical, de reconhecimento internacional, foi o geógrafo Milton Santos. Em seus trabalhos, apresenta uma visão crítica da sociedade capitalista. Sua obra “Por uma Geografia Nova” contém uma proposta geral para o estudo geográfico e possui conteúdo normativo. Argumentava que é necessário discutir o espaço social e ver a produção do espaço como objeto, considerando este espaço como histórico.Os autores a seguir foram representantes dessa Geografia, exceto:</br>
                                    </br>

                                    A) Josué de Castro.</br>
                                    ...
                                    <p><strong>Questão 1:</strong> Ele foi filósofo, geógrafo e historiador, viveu em Roma. Escreveu uma importante obra, em dezessete volumes, a qual denominou Geographia,com histórias e descrição de lugares e dos povos do mundo que ele conhecia, como resultado de fatos observados em viagens e informações de viajantes. Referimo-nos a:</br>
                                    </br>

                                    </p>

                                    <p><strong>Questão 2:</strong> A Teoria Malthusiana está fundamentada em qual relação?</br>
