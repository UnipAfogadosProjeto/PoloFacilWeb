                        ...
                        <div class="hpanel email-compose mailbox-view">
                            ...
                            <div class="border-top border-left border-right bg-light">
                                <div class="p-m custom-address-mailbox">
                                    ...
                                    <div>
                                       <strong><span class="font-extra-bold">Código da Prova: </span> 19194056289</strong>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                     ...
                                     <div>
                                        <strong><span class="font-extra-bold">I -Questões objetivas –valendo  10,00 pontos Gerada em:  01/04/2019 11:09:24</span></strong>
                                    </div>
                            ...
                            <div class="panel-body panel-csm">
                                <div>
                                    ...
                                    <p><strong>Questão 1:</strong>  Sobre o ser humano, o correto é afirmar que: </br>
                                    </br>
                                    ...
                                    <p><strong>Questão 2:</strong> A espécie humana apresenta diferenças anatômicas e fisiológicas, porém essas diferenças biológicas não determinam o comportamento das pessoas. Usando como exemplo o caso das mulheres, podemos afirmar que:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 3:</strong> “O modo de ver o mundo, as apreciações de ordem moral e valorativa, os diferentescomportamentos sociais e mesmo as posturas corporais são produtos de uma”:</br>
                                    </br>

                                    A) característica pessoal, essencialmente psicológica.</br>

                                    B) atitude filosófica, inteiramente reflexiva.</br>

                                    C) cultura herdada, até mesmo pré-científica.</br>

                                    D) ciência humana, como a antropologia.</br>

                                    E) mudança de comportamento.</br>

                                    </p>

                                    <p><strong>Questão 4:</strong> A cultura nos permite dar soluções para a sobrevivência, a vida prática; mas também nos possibilita atribuir valores, uma concepção simbólica e moral para o mundo. Quando não aceitamos soluções e valores diferentes daqueles que aprendemos em nossa cultura de origem, estamos praticandoo que segue:</br>
                                    </br>

                                    A) Aculturação.</br>

                                    B) Endoculturação e socialização.</br>

                                    C) Multiculturalismo.</br>

                                    D) Relativismo cultural.</br>
                                    ...
                                    <p><strong>Questão 5:</strong> Duas concepções básicas de cultura integram-se no modo de ser dos povos: num sentido, todas as dimensões sociais originam-se da cultura (política, geografia, economia), em outro, cultura é mais uma dimensão em meio às demais. A partir desta afirmação, assinale a alternativa correta.</br>
                                    </br>

                                    A) Uma concepção envolve todas as expressões de um povo. A outra, mais particular, é definida pela dimensão básica das crenças, valores e símbolos.</br>

                                    B) São correntes inquestionáveis, deterministas, mas uma tem base na biologia (a humanidade é essencialmente produto biológico), outra, na geografia (a humanidade é essencialmente produto territorial, ambiental).</br>

                                    C) Uma é cientificista e outra, religiosa, que sempre andam juntas.</br>

                                    D) Uma é antropológica e outra, religiosa, muito parecidas.</br>

                                    E) Uma é relativista e outra, absoluta, quase idênticas. </br>

                                    </br>

                                    </p>

                                    <p><strong>Questão 6:</strong>  Sobre o relacionamento dos seres humanos com a cultura, é correto afirmar que:</br>
                                    </br>
                                    
                                    A) os seres humanos são determinados pela cultura e não há como modificá-la.</br>

                                    B) a falta de cultura é o que gera os conflitos contemporâneos.</br>

                                    C) o capitalismo acabou com a existência dos grandes pensadores e dos homens cultos.</br>

                                    D) os seres humanos são produtos e produtores da cultura.</br>

                                    E) a cultura não é para todos.</br>

                                    </br>

                                    </p>

                                    <p><strong>Questão 7:</strong> A antropologia adota um tipo de pesquisa de campo chamada “etnometodologia”. Nesse tipo de pesquisa, o observador permanece durante um tempo convivendo e participando da vida do grupo pesquisado. Um dos resultados mais importantes dessa metodologia para as ciências humanas consistiu em:</br>
                                    </br>

                                    A) Ao mergulhar nas razões mais profundas do comportamento do outro, passamos a ter uma nova compreensão sobre a diversidade cultural, e foram revelados os erros do etnocentrismo.</br>

                                    B) Esse tipo de pesquisa permitiu um avanço no aprofundamento do etnocentrismo, pois os pesquisadores demonstram a necessidade de haver uma única cultura mais avançada, que possa influenciar todas as outras.</br>

                                    C) Houve uma concordância em abandonar o relativismo cultural para que as diferentes culturas fossem mais respeitadas dentro de sua própria lógica.</br>

                                    D) O convívio com culturas diferentes permitiu aos cientistas humanos comprovar a tese do evolucionismo cultural, criando um padrão para podermos julgar em que aspectos cada cultura pode estar mais atrasada ou maisavançada em relação às outras.</br>

                                    E) O resultado mais importante consistiu em aperfeiçoar as técnicas de observação, como utilizar o caderno de campo para registrar os acontecimentos, além dos recursos áudio-visuais como fotografia, gravadores ou filmadoras.</br>
                                    
                                    </br>

                                    <p>

                                    <p><strong>Questão 8:</strong>  Inicialmente o conceito de cultura esteve vinculado à ideia de evolução e progresso, como um conjunto complexo que inclui o conhecimento, as crenças, a arte, a moral, o direito, os costumes e as outras capacidades ou os hábitos adquiridos pelo homem enquanto membro da sociedade (LARAIA, 2002). Esse conceito deu origem ao (à):</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 9:</strong> Sobre a teoria da evolução humana, sabemos atualmente que:</br>
                                    </br>
                                    ...
                                    <p><strong>Questão 10:</strong> Sabemos que a diversidade cultural desafia desde o início as explicações das Ciências Humanas. Uma delas defende que o meio físico -ambiente e clima -é determinante para os aspectos deuma cultura. A esse respeito, assinale a alternativa correta de acordo com a perspectiva da Antropologia:</br>
                                    </br>
                                    ...
                                    C) Essa afirmação é incorreta, uma vez que mesmo em climas frios temos algumas culturas que não se desenvolveram tanto.
